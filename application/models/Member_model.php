...
class Member_model extends CI_MODEL{
    ...
    function chartdata() // this method is used to get default month 
    {
        ...
        if($data)
        {
            ...
            $sql = "Select * From terrif Where FIND_IN_SET (".$data[0]['toolplaza']." ,toolplaza) AND (start_date <= '".$start_date."' AND end_date >= '".$end_date."')";// this line is to bring tarrif values if exists within specific dates
