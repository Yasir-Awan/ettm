...
public function expand($para1 = '' , $para2 = '', $para3 =''){
	...
	foreach($expanded_data['expanded_data'] as $expanded)
	{
		...
		{
			$actionStatus[] = $faulty_comp_name." Faulty";
		}
		elseif($expanded['action_status']=="12")
		{
			$actionStatus[] = $faulty_comp_name." Replaced";
		}
		...
		{
			$actionStatus[] = $faulty_comp_name." Reinstalled";
		}
		elseif($expanded['action_status']=="15")
		{
			$actionStatus[] = $faulty_comp_name." Retired";
		} 
	}
...
public function add_asset_components($para1='',$para2='',$para3='')
	{  
		...
		// echo $para1;
		// echo $para2;
		// echo "in controller function add_asset_components"; 
