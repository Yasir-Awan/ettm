...
class ApiItemRepairWarrantyController extends REST_Controller
{
    ...
    public function index_post($id)
    {
        ...
        if ($id) {
            ...
            // $installed_id = $this->post('installed_id');
            ...
            if ($have_subitems == 1) {
                $subitems = $this->db->get_where('installed_subitems', array('installed_id' => $installed_items[0]['id']))->result_array();
            ...
            // if (!empty($item_faulty)) {
            //     $this->response($item_faulty, 200);
            // }
        } else {
