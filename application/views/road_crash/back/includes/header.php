            ...
            <div class="main-menu">
                ...
                <nav>
                        ...
                        <a style="color:#fff;" href="<?php echo base_url();?>admin/dashboard_dtr" aria-expanded="true" ><i style="color:#fff;" class="ti-dashboard"></i><span> DTR Overall</span></a>
                            ...
                            <li>
                                <a style="color:#fff;" href="<?php echo base_url();?>admin" aria-expanded="true" ><i style="color:#fff;" class="fas fa-road"></i><span>Road Crash Data</span></a>
                                  <ul class="collapse <?php if($page == 'crash_data'){echo 'in';}?>">
                                    <li <?php if($page == 'crash_list')echo "class='active'";?> onclick=>
                                    <!-- <a style="color:#fff;" href="<?php echo base_url()?>admin_crash"><img  src="<?php echo base_url();?>assets/back/images/icon/accident.png" alt="bus"  style="" > <span>Crash List</span></a> -->
                                    </li>
                                    <li <?php if($page == 'driver_list')echo "class='active'";?>>
                                    <!-- <a href="<?php echo base_url()?>admin/admins"><img  src="<?php echo base_url();?>assets/back/images/icon/driver.png" alt="driver"  style="width:35px; height:32px;" > <span>Driver List</span></a></li>  -->
                                    <li <?php if($page == 'images_list')echo "class='active'"?> style="padding-left:3%"; >
                                    <!-- <a href="<?php echo base_url()?>admin/admins"><i style="color:#fff;" class="fas fa-image"></i> <span>Images List</span></a></li>  -->
                                  </ul>
                            </li>
