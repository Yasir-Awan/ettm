  ...
  <!-- CARD for DataTales START -->
       ...
       <div class="col-lg-12 shadow mb-1 mt-3 d-none d-lg-block">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="tab  nav-link " id="asset" data-toggle="tab" href="#assets" role="tab" aria-controls="assets" aria-selected="false" onclick="ajax_html('<?php echo base_url()?>member_inventory/tabs/assets/','displaying_assets');">Assets</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="tab nav-link " id="item-tab" data-toggle="tab" data-target="#item" href="#" role="tab" aria-controls="home" aria-selected="true" onclick="ajax_html('<?php echo base_url()?>member_inventory/tabs/items/','displaying_items');">ITEMS</a>
                                    </li>
                                    
                                    <li class="nav-item">
                                        <a class="tab  nav-link" id="site" data-toggle="tab" href="#sites" role="tab" aria-controls="sites" aria-selected="false" onclick="ajax_html('<?php echo base_url()?>member_inventory/tabs/sites/','displaying_sites');">Sites</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="tab nav-link" id="location" data-toggle="tab" href="#locations" role="tab" aria-controls="locations" aria-selected="false" onclick="ajax_html('<?php echo base_url()?>member_inventory/tabs/locations/','displaying_locations');">Locations</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="tab nav-link" id="supplier" data-toggle="tab" href="#suppliers" role="tab" aria-controls="suppliers" aria-selected="false" onclick="ajax_html('<?php echo base_url()?>member_inventory/tabs/suppliers/','displaying_suppliers');">Suppliers</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="tab nav-link" id="support_provider" data-toggle="tab" href="#support_providers" role="tab" aria-controls="support_providers" aria-selected="false" onclick="ajax_html('<?php echo base_url()?>member_inventory/tabs/support_providers/','displaying_support_providers');">T.S.P</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="tab nav-link" id="manufacturer" data-toggle="tab" href="#manufacturers" role="tab" aria-controls="manufacturers" aria-selected="false" onclick="ajax_html('<?php echo base_url()?>member_inventory/tabs/manufacturers/','displaying_manufacturer');">Manufacturers</a>
                                    </li>
                                </ul>
...
<!-- Firts Page Js Start -->
    ...
    var user_type = 'member_inventory';
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url()?>member_inventory/first_page/assets_publish_set/' + id + '/'+ mode,
      cache       : false,
      contentType : false,
      processData : false,
  ...
  $('body').on('click', '#item-tab', function (event){
            $.ajax({ 
            url: "<?php echo base_url();?>member_inventory/items/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
...
$('body').on('click', '#asset', function (event){
   ...
   var list = event.target.id;
    ...
    var id=$( this ).val();
            ...
            $.ajax({ 
            url: "<?php echo base_url();?>member_inventory/assets/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
...
$('body').on('click', '#site', function (event){
   var list = event.target.id;
    ...
    var id=$( this ).val();
            ...
            $.ajax({ 
            url: "<?php echo base_url();?>member_inventory/sites/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
...
$('body').on('click', '#location', function (event){
   var list = event.target.id;
    ...
    var id=$( this ).val();
            ...
            $.ajax({ 
            url: "<?php echo base_url();?>member_inventory/locations/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
...
$('body').on('click', '#supplier', function (event){
   var list = event.target.id;
    ...
    var id=$( this ).val();
            ...
            $.ajax({ 
            url: "<?php echo base_url();?>member_inventory/suppliers/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
...
$('body').on('click', '#support_provider', function (event){
   var list = event.target.id;
    ...
    var id=$( this ).val();
            ...
            $.ajax({ 
            url: "<?php echo base_url();?>member_inventory/tsp/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
...
$('body').on('click', '#manufacturer', function (event){
   var list = event.target.id;
    ...
    var id=$( this ).val();
            ...
            $.ajax({ 
            url: "<?php echo base_url();?>member_inventory/manufacturers/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
