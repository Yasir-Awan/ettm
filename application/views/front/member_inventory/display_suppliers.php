              ...
              <div class="row">
                <div class="col-sm-12 pl-1 pr-1">
                    ...
                    <div class='row mb-1 mt-1' >
                      <div class='col-md-4'>
                       ...
                       <div class="col-md-4">
                        ...
                        <div class='col-md-4'>
                          <button type="button" class="btn btn-primary btn-xs pull-right" style="line-height: 0.5; " data-toggle="modal" data-target="#location-modal" onclick="ajax_html('<?php echo base_url()?>member_inventory/add_supplier/','adding_suppliers');">
                  ...
                  <tr role="row" class="odd">
                      ...
                      <td> <span class="btn btn-success btn-xs btn-labeled fas fa-edit" id="cancel_reason" name="location_edit" onclick="ajax_html('<?php echo base_url().'member_inventory/supplier_edit/'.$supplier['id'];?>','edit_supplier_contents');" data-toggle="modal" data-target="#supplier-edit">&nbsp;Edit</span>
                     &nbsp
                    <span class="btn btn-danger btn-xs  fas fa-trash-alt" onclick="delete_confirm_tab('Really want to delete This','<?php echo base_url().'member_inventory/suppliers/delete/'.$supplier['id'];?>')" > 
                    Delete</span></td>
                       <?php } ?>
                    </tr>
