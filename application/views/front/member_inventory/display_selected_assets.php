...
<span align='center'><h5 style="color: #030a10; ">Asset Core Information</h5></span>
        ...
        <div class="col-md-2">
        <span class="btn btn-success pull-right btn-xs btn-labeled " id="cancel_reason" name="asset_edit" onclick="ajax_html('<?php echo base_url().'member_inventory/asset_edit/'.$asset['id'];?>','edit_asset_contents');" data-toggle="modal" data-target="#assets-edit" style='margin-right:-260px;'> <i class="fa fa-edit"> </i> &nbsp; Edit</span>
        </div>             
        <div class="col-md-2">
                    <span class="btn btn-danger btn-xs  fas fa-trash-alt" style='margin-left:235px;' onclick="delete_confirm_tab('Really want to delete This','<?php echo base_url().'member_inventory/assets/delete/'.$asset['id'];?>')"> 
                    Delete</span>
                    </div> 
                    </div> 
