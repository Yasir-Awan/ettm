                    ...
                    <div class='row mb-1 mt-1' >
                      <div class='col-md-4'>
                       ...
                       <div class="col-md-4">
                        ...
                        <div class='col-md-4'>
                          <button type="button" class="btn btn-primary btn-xs pull-right" style="line-height: 0.5; " data-toggle="modal" data-target="#add_locations" onclick="ajax_html('<?php echo base_url()?>member_inventory/add_location/','adding_locations');">
                              Add Location </button>
                         </div> <!-- col-md-4 END -->
                     </div><!-- row END -->
...
<div id="adding_locations"></div>
  ...
  <!--**********************************************************-->
                  ...
                  <tr role="row" class="odd">
                      ...
                      <td><span class="btn btn-success btn-xs btn-labeled fas fa-edit" id="cancel_reason" name="location_edit"  data-toggle="modal" data-target="#location-edit" onclick="ajax_html('<?php echo base_url().'member_inventory/location_edit/'.$location['id'];?>','edit_location_contents');">&nbsp;Edit</span>
                     &nbsp
                    <span class="btn btn-danger btn-xs  fas fa-trash-alt" onclick="delete_confirm_tab('Really want to delete This','<?php echo base_url().'member_inventory/locations/delete/'.$location['id'];?>')" > 
                    Delete</span></td>
                      <?php } ?>
                    </tr>
                   </tbody>
