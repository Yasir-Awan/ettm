<?php echo form_open(base_url()."member_inventory/action_on_asset/start_repair_do/",array('id' => 'startrepair'));?>
...
<script>
        ...
        $('body').on('change', "#tsp_person_type", function (){ 
          var tsp = $('#repairing_tsp').val();
             ...
             $.ajax({ 
              url: "<?php echo base_url() ?>member_inventory/action_on_asset/repairing_tsp/"+tsp+"/"+person_type,
              cache       : false,
              contentType : false,
              processData : false,
              beforeSend: function() {
...
<script>
        ...
        $('body').on('change', "#tsp_person", function (){ 
          ...
          var tsp = $('#tsp_person_type').val();
            ...
            //var person_type = this.value;
             $.ajax({ 
              url: "<?php echo base_url() ?>member_inventory/action_on_asset/person_contact/"+tsp+"/"+tsp_person,
              cache       : false,
              contentType : false,
              processData : false,
              beforeSend: function() {
