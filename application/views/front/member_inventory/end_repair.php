<?php echo form_open(base_url()."member_inventory/action_on_asset/end_repair_do/",array('id' => 'endrepair'));?>
...
<span class="btn btn-primary pull-right" onclick="form_submit('endrepair');">Start Repairing</span>
          <?php echo form_close();?>
