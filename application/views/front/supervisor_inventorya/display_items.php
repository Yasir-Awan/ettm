...
<div class='row mt-3 mb-2'>
   <div class='col-md-12' style='padding-right: 22px;'>
     <button type="button" class="btn btn-success btn-xs fa fa-plus pull-right " data-toggle="modal" data-target="#modal-items" style="background-color:#b90e2b; outline:none;" onclick="ajax_html('<?php echo base_url()?>supervisor_inventory/add_item/','adding_items');"> Add Items</button>
   </div>
  </div>
            ...
            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
              <div class="row">
                <div class="col-sm-12 pl-1 pr-1">
                      <table class="table table-bordered dataTable" id="dataTabl" width="100%" cellspacing="0" role="grid"; aria-describedby="dataTable_info" style="width: 100%; ">
                  <thead align='center'>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width:auto;">Category</th>
                ...
                <td>
                    <span class="btn btn-success btn-sm btn-labeled fa fa-edit" id="cancel_reason" name="item_edit" onclick="ajax_html('<?php echo base_url().'supervisor_inventory/items_edit/'.$item['id'];?>','edit_item_contents');" data-toggle="modal" data-target="#items-edit">&nbsp;Edit</span>
                     &nbsp
                    <span class="btn btn-danger btn-sm  fa fa-trash" onclick="delete_confirm_tab('Really want to delete This','<?php echo base_url().'supervisor_inventory/items/delete/'.$item['id'];?>')"> 
                    Delete</span>
                </td>
                <!-- <?php // } ?> -->
                    </tr>
