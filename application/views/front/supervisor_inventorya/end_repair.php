...
<div class="form-group">
         ...
         <div class="form-group">
                ...
                <div class='col-md-5'>
                <select class="form-control required" name="item_site" id="item_site" placeholder="Select Asset Name" >
         ...
         <div class="form-group">
                ...
                <div class='col-md-5'>
                <select class="form-control required" name="selected_locations" id="selected_locations" placeholder="Select Asset Location" >
                    <!-- <option value=""><?php echo "Select Option";?></option> -->
          ...
          <div class="form-group">
                <div class="row">
                <div class='col-md-4'>  
                  <label for="example-date-input" class="col-form-label">Repair Complete</label>
                </div>
                <div class='col-md-4'>
                <input type="text" class="form-control required" id="repair_completion" name="repair_completion" placeholder="expected Date">
                </div>
                <div class='col-md-3'>
...
<span class="btn btn-primary pull-right" onclick="form_submit('endrepair');">End Repairing</span>
          <?php echo form_close();?>
