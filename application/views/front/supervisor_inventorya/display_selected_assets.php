...
<tbody>
    ...
    <th scope="row"><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;margin-left: ;">Current Status</span></th>
      ...
      <th scope="row"><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;margin-left: ;"><?php   echo "No action performed on this Asset.";  ?></span></th>
        ...
        <?php 
              foreach($selected_asset_transaction as $transaction){
    ...
    <tr>
      ...
      <th><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;margin-left: ;">Installing Company:</span></th>
                         <?php    if($transaction['organisation_type']==2)
                               {
    ...
    <tr>
      ...
      <?php  
         ...
         ?>
      <th><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;margin-left:-20px;">Reinstalled at Site:</span></th>
    ...
    <tr>
      ...
      <td><span style="font-size: 0.80rem;color: #030a10;margin-left:;"><?php echo $added_by[0]['fname']." ".$added_by[0]['lname'];?></span></td>
            <?php } ?>
            <th scope="row"><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;margin-left: ;">Checkin Reason:</span></th>
      <td><span style="font-size: 0.80rem;color: #030a10;margin-left:;"><?php echo $transaction['action_comments'];?></span></td>
    </tr> 
    <tr>
      <!-- <th scope="row"><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;margin-left: ;">Repairing Reason:</span></th>
...
<div class="row ">
                    <div class="col-md-9">
                     ...
                     <div class="col-md-3">
                     <?php foreach($selected_assets as $asset) {?>
                      <a href="#" onclick="show_history('<?php echo base_url().'supervisor_inventory/asset_history/list/'.$asset['id'];?>','display_asset_history');" class="fa fa-angle-double-left pull-right">View full History</a>
                     <?PHP } ?>
                    </div>
                </div>
<thead>
...
<?php 
              if($transactions){
        if($transactions[0]['transaction_type']!==1 && $transactions[0]['transaction_type']!==2 && $transactions[0]['transaction_type']!==3 && $transactions[0]['transaction_type']!==4 && $transactions[0]['transaction_type']!==5 && $transactions[0]['transaction_type']!==6 && $transactions[0]['transaction_type']!==7 && $transactions[0]['transaction_type']!==8 && $transactions[0]['transaction_type']!==9)
        {?><tr><td align="center"><?php echo "It was Brand New Item."; exit; ?></td></tr>  <?php } ?>
     <?php if($transactions[0]['transaction_type']==1){ ?>
      <tr><td align="center"><?php echo "This item was Checked out."; exit; ?></td></tr>  <?php } ?>
     <?php 
    ...
    <tr>
      ...
      <?php 
            ...
            if($transaction[1]['retire_type']==5)
            {
              $retireType = "Consumed";
            }
          ?>
    ...
    <tr>
      ...
      <?php
            if($transactions[1]['user_type']==1){ 
            $added_by = $this->db->get_where('admin',array('id' => $transaction[1]['added_by']))->result_array();
          ?>
      <td><span style="font-size: 0.80rem;color: #030a10;margin-left:;"><?php echo $added_by[0]['fname']." ".$added_by[0]['lname'];?></span></td>
            <?php } ?>
      <?php
