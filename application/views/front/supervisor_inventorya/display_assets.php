                      ...
                      <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                       ...
                       <div class="col-md-2" style="padding:unset;">
                        ...
                        <div class='col-md-4' style='width:auto;'>
                          <button type="button"  class="btn btn-primary btn-xs pull-right" style="line-height: 0.5; " data-toggle="modal" data-target="#addassets" onclick="ajax_html('<?php echo base_url()?>supervisor_inventory/add_asset/','adding_assets');">
                              Add Asset </button>
                         </div><!-- col-md-4 END -->
                     </div><!-- row END -->
                   <!-- Add Assets & Action Button END -->
                      <table class="table table-bordered dataTable" id="Table_S_A_D" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: auto%;">
                  <thead>
                    <tr role="row">
...
function ajax_html_cust(url,id){
  ...
  var assets = [];
            ...
            var result = $('#Table_S_A_D').find('input[type="checkbox"]:checked');
        ...
        {
          $('#Table_S_A_D').find('input[type="checkbox"]:checked').each(function(){    
