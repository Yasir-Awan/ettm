              ...
              <div class="row">
                <div class="col-sm-12 pl-1 pr-1">
                    ...
                    <div class='row mb-1 mt-1' >
                      <div class='col-md-4'>
                       ...
                       <div class="col-md-4">
                        ...
                        <div class='col-md-4'>
                          <button type="button" class="btn btn-primary btn-xs pull-right" style="line-height: 0.5; " data-toggle="modal" data-target="#site-modal" onclick="ajax_html('<?php echo base_url()?>supervisor_inventory/add_site/','adding_sites');">
                              Add Sites </button>
                         </div> <!-- col-md-4 END -->
                     </div><!-- row END -->
                  ...
                  <tr role="row" class="odd">
                      ...
                      <td> <span class="btn btn-success btn-xs btn-labeled fas fa-edit" id="cancel_reason" name="site_edit" onclick="ajax_html('<?php echo base_url().'supervisor_inventory/site_edit/'.$site['id'];?>','edit_site_contents');" data-toggle="modal" data-target="#site-edit">&nbsp;Edit</span>
                     &nbsp
                    <span class="btn btn-danger btn-xs  fas fa-trash-alt" onclick="delete_confirm_tab('Really want to delete This','<?php echo base_url().'supervisor_inventory/sites/delete/'.$site['id'];?>')" > 
                    Delete</span></td>
                       <?php } ?>
                    </tr>
