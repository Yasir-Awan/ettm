...
<div class="table-responsive">
    ...
    <table class="table" id="dataTableEntry" width="100%">
      ...
      <tbody>
        ...
        <tr>
         ...
         ?>
          ...
          <td>
            <a class="btn btn-success btn-sm" target="_blank" data-toggle="modal" data-target="#entryView" onclick="ajax_html('<?php echo base_url()?>toolplaza/Traffic_View/view/<?php echo $row['id']?>', 'entryView_contents');"><i class="fa fa-eye"></i>View</a>
            <a href="<?php echo base_url()?>toolplaza/Traffic_View/print_view/<?php echo $row['id']?>" class="btn btn-info btn-sm" target="_blank"><i class="fa fa-eye"></i>Print View</a>
