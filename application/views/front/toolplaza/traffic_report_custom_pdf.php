                                        ...
                                        <table class="table table-bordered table-hover"  border="1px solid;" text-align="center">
                                            <thead>
                                                <tr class="text-capitalize" style="text-align:center; background-color:#cccccc;">
                                                    ...
                                                    <th><div style="line-height:40px;">Date</div></th>
                                            ...
                                            <tbody>
                                                <?php if(!empty($row['records'])){ 
                                                    ...
                                                    ?>
                                              <tr style="text-align:center;">
                                                    <td rowspan="3"><div style="line-height:50px"><?php echo date("d-m-Y",strtotime($sub_row['for_date']));?></div></td>
                                                    
                                                    <td><div style="line-height:50px">Traffic</div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class1'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class2'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class3'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class4'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class5'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class6'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class7'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class8'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class9'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class10'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo ($sub_row['class1'] + $sub_row['class2'] + $sub_row['class3'] + $sub_row['class4'] + $sub_row['class5'] + $sub_row['class6'] + $sub_row['class7'] + $sub_row['class8'] + $sub_row['class9'] + $sub_row['class10']);?></div></td>
                                                </tr>
                                                <tr style="text-align:center;">
                                                    <td><div style="line-height:50px">Exempt</div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class1_exempt'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class2_exempt'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class3_exempt'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class4_exempt'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class5_exempt'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class6_exempt'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class7_exempt'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class8_exempt'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class9_exempt'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo $sub_row['class10_exempt'];?></div></td>
                                                    <td><div style="line-height:50px"><?php echo ($sub_row['class1_exempt'] + $sub_row['class2_exempt'] + $sub_row['class3_exempt'] + $sub_row['class4_exempt'] + $sub_row['class5_exempt'] + $sub_row['class6_exempt'] + $sub_row['class7_exempt'] + $sub_row['class8_exempt'] + $sub_row['class9_exempt'] + $sub_row['class10_exempt']);?></div></td>
                                                </tr>
                                               ...
                                               <tr style="text-align:center;">
                                                    ...
                                                    <td><div style="line-height:30px">Total</div></td>
