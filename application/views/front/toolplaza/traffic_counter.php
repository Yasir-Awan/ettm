            ...
            <div class="card">
              <div class="card-header">
               <!--  <h4 class="card-title"> Monthly Traffic Report</h4> -->
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title">Traffic Counting Reports</h4>
                    </div>
...
$(document).ready(function(){
            $.ajax({ 
            url: "<?php echo base_url();?>toolplaza/traffic_counting/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
...
<div class="modal fade" id="counterAdd">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Traffic Counting Session</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
              <div id="counterAdd_contents">
              </div>  
            </div>
