          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Daily Traffic Report</h4>
                <span class="btn btn-success btn-sm pull-right"  data-toggle="modal" data-target="#dtrAdd" onclick="ajax_html('<?php echo base_url()?>toolplaza/dtr/add/', 'dtrAdd_contents');"><i class="fa fa-plus"></i>Add New Report</span>
              </div>
              <div class="card-body">
                <div id="list"></div>
              </div>
...
$(document).ready(function(){
            $.ajax({ 
            url: "<?php echo base_url();?>toolplaza/dtr/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
...
<div class="modal fade" id="dtrAdd">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Daily Traffic Report</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
              <div id="dtrAdd_contents">
              </div>  
            </div>
...
<div class="modal fade" id="dtrEDIT">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Daily Traffic Report</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
              <div id="dtrEDIT_contents">
              </div>  
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
