     ...
     <?php echo form_open_multipart(base_url().'toolplaza/traffic_counting/do_update', array('id' => 'traffic_counter_end', 'method' => 'post'));?>
                 <div class="row">
                    ...
                    <div class="col-md-12 pr-1">
                      ...
                      <div class="form-group">
                        <label>Comment</label>
                        <textarea class="form-control required" style="border: 1px solid #d4d6d4;" name="comment" id="comment" rows="3">
                        </textarea>
                      </div>
