<div class="row">
  <div class="col-md-12">
    <span class="btn btn-success btn-sm pull-left"  data-toggle="modal" data-target="#counterAdd" onclick="ajax_html('<?php echo base_url()?>toolplaza/traffic_counting/add/', 'counterAdd_contents');"><i class="fa fa-plus"></i>Add New Session</span>
  </div>
</div>
      ...
      <tbody>
        ...
        <tr>
         ...
         ?>
          ...
          <td>
            <a class="btn btn-success btn-sm" target="_blank" data-toggle="modal" data-target="#counterView" onclick="ajax_html('<?php echo base_url()?>toolplaza/traffic_counting/view/<?php echo $row['id']?>', 'counterView_contents');"><i class="fa fa-eye"></i>View</a>
            ...
            <?php } ?>
            <?php if($row['user_type'] == 2 && $row['user_id'] == $this->session->userdata('supervisor_id') && !$row['video_end_date']){?>
          
           
                <a href="<?php echo base_url()?>toolplaza/traffic_counting/session_start/<?php echo $row['id']?>" class="btn btn-info btn-sm" style="margin-top:1%;"><i class="fa fa-trash" ></i>Restart</span>
            <?php } ?>
          </td>
        </tr>
        <?php } 
