                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="invoice-area">
                                    <div class="invoice-head">
                                        <div class="row">
                                            ...
                                            <div class="iv-right col-6 text-md-right">
                                                <div class"row">
                                                    <div class="col-md-12">
                                                        <span><h5 style="color: #030a10; ">DAILY TRAFFIC REPORT (DTR) SUMMARY FOR N.H.A</h5></span>
                                                    </div>
                                                </row>
                                                <div class"row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;margin-left: 20%;">Date</span><span style="font-size: 0.80rem;color: #030a10;margin-right: 10%;"><?php echo date("d, F, Y",strtotime($dtr[0]['for_date']));?></span>
                                                       <!-- <?php if($dtr[0]['type'] == 2){
                                                                $month_year = explode('-',$dtr[0]['for_month']);
                                                                $start_date = $month_year[0].'-'.$month_year[1].'-'.$dtr[0]['start_date'];
                                                                $end_date = $month_year[0].'-'.$month_year[1].'-'.$dtr[0]['end_date'];
                                                        ?>
                                    ...
                                    <div class="invoice-table table-responsive mt-5">
                                        <table class="table table-bordered table-hover text-right">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="text-center"><?php echo $dtr[0]['description'];?></td>
                                                   <td class="text-left"><?php echo $dtr[0]['notes'];?></td>
                                                   <td><?php echo number_format($dtr[0]['class1']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class2']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class3']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class4']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class5']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class6']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class7']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class8']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class9']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class10']);?></td>
                                                    
                                                    <td><?php echo number_format($dtr[0]['total']);?></td>
                                                </tr>
                                                <?php 
                                                    if($exempt){
                                                ?>
                                                ...
                                                <tr>
                                                   ...
                                                   <?php 
                                                        if($exempt){
                                                   ?>
                                                   <td><?php echo number_format(($dtr[0]['class1'] - $exempt[0]['class1']) * $terrif[0]['class_1_value']);?></td>
                                                    <td><?php echo number_format(($dtr[0]['class2'] - $exempt[0]['class2']) * $terrif[0]['class_2_value']);?></td>
                                                    <td><?php echo number_format(($dtr[0]['class3'] - $exempt[0]['class3']) * $terrif[0]['class_3_value']);?></td>
                                                    <td><?php echo number_format(($dtr[0]['class4'] - $exempt[0]['class4']) * $terrif[0]['class_4_value']);?></td>
                                                    <td><?php echo number_format(($dtr[0]['class5'] - $exempt[0]['class5']) * $terrif[0]['class_5_value']);?></td>
                                                    <td><?php echo number_format(($dtr[0]['class6'] - $exempt[0]['class6']) * $terrif[0]['class_6_value']);?></td>
                                                    <td><?php echo number_format(($dtr[0]['class7'] - $exempt[0]['class7']) * $terrif[0]['class_7_value']);?></td>
                                                    <td><?php echo number_format(($dtr[0]['class8'] - $exempt[0]['class8']) * $terrif[0]['class_8_value']);?></td>
                                                    <td><?php echo number_format(($dtr[0]['class9'] - $exempt[0]['class9']) * $terrif[0]['class_9_value']);?></td>
                                                    <td><?php echo number_format(($dtr[0]['class10'] - $exempt[0]['class10'])* $terrif[0]['class_10_value']);?></td>
                                                    <td><?php echo number_format((($dtr[0]['class1'] - $exempt[0]['class1']) * $terrif[0]['class_1_value']) + (($dtr[0]['class2'] - $exempt[0]['class2']) * $terrif[0]['class_2_value']) + (($dtr[0]['class3'] - $exempt[0]['class3']) * $terrif[0]['class_3_value']) + (($dtr[0]['class4'] - $exempt[0]['class4']) * $terrif[0]['class_4_value']) + (($dtr[0]['class5'] - $exempt[0]['class5']) * $terrif[0]['class_5_value']) + (($dtr[0]['class6'] - $exempt[0]['class6']) * $terrif[0]['class_6_value']) + (($dtr[0]['class7'] - $exempt[0]['class7']) * $terrif[0]['class_7_value']) + (($dtr[0]['class8'] - $exempt[0]['class8']) * $terrif[0]['class_8_value']) + (($dtr[0]['class9'] - $exempt[0]['class9']) * $terrif[0]['class_9_value']) + (($dtr[0]['class10'] - $exempt[0]['class10']) * $terrif[0]['class_10_value']));?></td>
                                                    
                                                   <?php }else{?>
                                                    <td><?php echo number_format($dtr[0]['class1'] * $terrif[0]['class_1_value']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class2'] * $terrif[0]['class_2_value']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class3'] * $terrif[0]['class_3_value']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class4'] * $terrif[0]['class_4_value']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class5'] * $terrif[0]['class_5_value']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class6'] * $terrif[0]['class_6_value']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class7'] * $terrif[0]['class_7_value']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class8'] * $terrif[0]['class_8_value']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class9'] * $terrif[0]['class_9_value']);?></td>
                                                    <td><?php echo number_format($dtr[0]['class10'] * $terrif[0]['class_10_value']);?></td>
                                                    <td><?php echo number_format(($dtr[0]['class1'] * $terrif[0]['class_1_value']) + ($dtr[0]['class2'] * $terrif[0]['class_2_value']) + ($dtr[0]['class3'] * $terrif[0]['class_3_value']) + ($dtr[0]['class4'] * $terrif[0]['class_4_value']) + ($dtr[0]['class5'] * $terrif[0]['class_5_value']) + ($dtr[0]['class6'] * $terrif[0]['class_6_value']) + ($dtr[0]['class7'] * $terrif[0]['class_7_value']) + ($dtr[0]['class8'] * $terrif[0]['class_8_value']) + ($dtr[0]['class9'] * $terrif[0]['class_9_value']) + ($dtr[0]['class10'] * $terrif[0]['class_10_value']));?></td>
                                                    <?php } }else{ ?>
                                                    <td class="text-center" colspan="11"><span class="text-danger">Tarrif for this dtr is not added yet.</span></td>
                                                     <?php    }?>
                                                </tr>
                                            </tbody>
                                ...
                                <a href="<?php echo base_url()?>toolplaza/dtr_generate_pdf/<?php echo $dtr[0]['id'];?>" class="btn btn-info pull-right"><i class="fa fa-file-pdf-o"></i> &nbsp;Generate PDF</a>
                            </div>
                        </div>
                    </div>
                </div>
