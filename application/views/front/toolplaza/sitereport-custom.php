...
<head>
	...
	<title>Report - DSR</title><link rel="stylesheet" href="<?php echo base_url()?>assets/back/css/bootstrap.min.css"><link rel="stylesheet" href="<?php echo base_url()?>assets/back/css/styles.css">
</head>
<body><!-- page title area end -->
	...
	<div class="main-content-inner">
		<div class="row">
			<div class="col-md-12">
				...
				<!--status report end-->
				<!--documents start-->
				<?php if(empty($support_request) && empty($generator_log)){}else{ include('dsr/view/documents.php'); }?>
				<!--documents end-->
				<!--Feedback Start-->
				<?php if(isset($dsr[0]['feedback'])){ include('dsr/view/feedback.php');  }else{ } ?>
				<!--Feedback End-->
				<!--Feedback Start-->
				<?php if($dsr[0]['toll_delay'] != ''){ include('dsr/view/delay.php');  }else{ } ?>
				<!--Feedback End-->
	...
	<?php }else { echo 'DSR of this Tollplaza is not submitted yet.';} ?>
