     ...
     <?php echo form_open_multipart(base_url().'toolplaza/dtr/do_update/'.$dtr[0]['id'], array('id' => 'edit_dtr', 'method' => 'post'));?>
                      ...
                      <div class="form-group">
                        ...
                        <Select class="form-control required" name="omc" id="omc">
                            ...
                            <?php foreach($omc as $val){?>
                              <option value="<?php echo $val['id'];?>" <?php if($dtr[0]['omc']  == $val['id']){ echo "selected"; }?>><?php echo $val['name'];?></option>
                            <?php } ?>
                        </select> 
                      </div>
                    ...
                    <div class="col-md-6 pr-1">
                        <?php /*
                          $date = explode('-', $dtr[0]['for_month']);
                          //$date = substr( $dtr[0]['for_month'], 0, strrpos( $dtr[0]['for_month'], '-' ) );
                          
                                    $month = $date[0].'/'.$date[1];*/
                        ?>
                      <div class="form-group">
                        <label>Date</label>
                        <input type="text" class="form-control required" name="for_date" placeholder="Choose Month and Year" value="<?php echo $dtr[0]['for_date'];?>"> 
                      </div>
                  ...
                  <!--<?php if($dtr[0]['type'] == 2){?>
                        <div class="col-md-6 pr-1 start_date">
                              <div class="form-group">
                                  ...
                                  <?php 
                                    ...
                                    $date = explode('-', $dtr[0]['for_month']);
                                    $start_date = $dtr[0]['start_date'].'/'.$date[1].'/'.$date[0];
                                    $end_date = $dtr[0]['end_date'].'/'.$date[1].'/'.$date[0];
                        ...
                        $(document).ready(function(){
                            var id = <?php echo $dtr[0]['id']?>;
                            $.ajax({
                                type: 'POST',
                                url: '<?php echo base_url()?>toolplaza/check_start_date',
                                data: {formonth: $('#datePicker').val(),tollplaza:$('#tollplaza').val(),dtr_id:<?php echo $dtr[0]['id']?>},
                   ...
                   <?php }else{?>
                    ...
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="description" class="form-control required" value="<?php echo $dtr[0]['description'];?>" placeholder="Enter Description">
                      </div>
                      <div></div>
                    </div>
                    ...
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Notes</label>
                        <input type="text" name="notes" value="<?php echo $dtr[0]['notes'];?>" class="form-control required" placeholder="Enter Notes" value="No of Passages">
                      </div>
                    </div>
                    ...
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Class1</label>
                        <input type="number" name="class1" id="class1" class="form-control classes required" placeholder="Enter class1 passages" min="0" value="<?php echo $dtr[0]['class1'];?>">
                      </div>
                       <div></div>
                    </div>
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Class2</label>
                        <input type="number" name="class2" id="class2" class="form-control classes required" placeholder="Enter class2 passages" min="0" value="<?php echo $dtr[0]['class2'];?>" >
                      </div>
                       <div></div>
                    </div>
                    ...
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Class3</label>
                        <input type="number" name="class3" id="class3" class="form-control classes required" placeholder="Enter class3 passages" min="0" value="<?php echo $dtr[0]['class3'];?>">
                      </div>
                       <div></div>
                    </div>
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Class4</label>
                        <input type="number" name="class4" id="class4" class="form-control classes required" placeholder="Enter class4 passages" min="0" value="<?php echo $dtr[0]['class4'];?>">
                      </div>
                       <div></div>
                    </div>
                    ...
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Class5</label>
                        <input type="number" name="class5" id="class5" class="form-control classes required" placeholder="Enter class5 passages" min="0" value="<?php echo $dtr[0]['class5'];?>">
                      </div>
                       <div></div>
                    </div>
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Class6</label>
                        <input type="number" name="class6" id="class6" class="form-control classes required" placeholder="Enter class6 passages" min="0" value="<?php echo $dtr[0]['class6'];?>">
                      </div>
                       <div></div>
                    </div>
                    ...
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Class7</label>
                        <input type="number" name="class7" id="class7" class="form-control classes required" placeholder="Enter class7 passages" min="0" value="<?php echo $dtr[0]['class7'];?>">
                      </div>
                       <div></div>
                    </div>
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Class8</label>
                        <input type="number" name="class8" id="class8" class="form-control classes required" placeholder="Enter class8 passages" min="0" value="<?php echo $dtr[0]['class8'];?>">
                      </div>
                       <div></div>
                    </div>
                    ...
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Class9</label>
                        <input type="number" name="class9" id="class9" class="form-control classes required" placeholder="Enter class9 passages" min="0" value="<?php echo $dtr[0]['class9'];?>">
                      </div>
                       <div></div>
                    </div>
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Class10</label>
                        <input type="number" name="class10" id="class10" class="form-control classes required" placeholder="Enter class10 passages" min="0" value="<?php echo $dtr[0]['class10'];?>">
                      </div>
                       <div></div>
                    </div>
                    ...
                    <div class="col-md-6 pr-1">
                      ...
                      <div class="form-group">
                        <label>Total</label>
                        <input type="number" class="form-control" id="total" disabled="" placeholder="Total" value="<?php echo $dtr[0]['total'];?>">
                      </div>
                    </div>

                    <div class="col-md-4 pr-1 wrap-input-container">
                      <a href="<?php echo base_url()?>uploads/dtr/<?php echo $dtr[0]['file'];?>" class="btn btn-warning pull-right" target="__blank" style="padding: 1px 5px;font-size: 12px;
line-height: 1.5;border-radius: 3px;" id="viewfilebtn"><i class="fa fa-eye"></i>View File</a>
                      ...
                      <input class="file-upload form-control" name="dtr_file" type="file"  accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel ,application/pdf,image/*">
                   </div>
                  ...
                  <?php 
                        $support = $this->db->get_where('dtr_supporting_document',array('dtr_id' => $dtr[0]['id']))->result_array();
                        if($support){
                  ?>
                          ...
                          <table class="table">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <a href="#" class="btn btn-danger btn-xs" onclick="delete_con('<?php echo base_url(); ?>toolplaza/delete_suppporting/<?php echo $dtr[0]['id']; ?>/<?php echo $sprt['id']; ?>/')"><i class="fa fa-trash" ></i></a>
                                </td>
                              </tr>
                              <?php 
                                }
                 ...
                 <div id="dynamicInput2"></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 pr-1 wrap-input-container">
                      <span class="btn btn-info btn-block pull-right" onclick="form_submit('edit_dtr');">Update</span>
                  </div>
    ...
    $('#dtr_type').change(function(){
      ...
      if(this.value == 1){
        ...
        $.ajax({
              type: 'POST',
              url: '<?php echo base_url()?>toolplaza/check_start_date',
              data: {formonth: $('#datePicker').val(), dtr_id:<?php echo $dtr[0]['id']?>},
              success: function(data)
              {
                if(data == 'completed'){
                    notify('You have Complete dtr for This Month','danger','top','right');
