<div class="table-responsive">
  ...
  line-height: 1.5;border-radius: 3px;" onclick="ajax_html('<?php echo base_url().'toolplaza/mtr/view_reason/'.$row['id'];?>','viewreason_contents');" data-toggle="modal" data-target="#viewreason"><i class="fa fa-eye"></i>Reason</span>
                         <?php }?>
                        </td>
                        <td>
                          ...
                          <?php //if($row['status'] == 0){?>
                          <span class="btn btn-info btn-sm" onclick="ajax_html('<?php echo base_url().'toolplaza/mtr/edit/'.$row['id'];?>','mtrEDIT_contents');" data-toggle="modal" data-target="#mtrEDIT"><i class="fa fa-edit"></i>Edit</span>
                          <?php //} ?>
                          ...
                          <?php } ?>
                          <a href="<?php echo base_url()?>uploads/mtr/<?php echo $row['file'];?>" style="margin-top:1%;" class="btn btn-primary btn-sm" target="__blank"><i class="fa fa-paperclip" aria-hidden="true"></i>View Attachment</a>
                          <?php if($support){?>
                          <span class="btn btn-default btn-sm" style="margin-top:1%;" onclick="ajax_html('<?php echo base_url().'toolplaza/view_supporting/'.$row['id'];?>','support_contents');" data-toggle="modal" data-target="#support"><i class="fa fa-eye"></i>Suppporting Files</span>
                          <?php } ?>
                        </td>
                      </tr>
                      <?php } ?>
