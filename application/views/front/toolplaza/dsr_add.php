...
<div>
	<div>
		<?php if(isset($page)){ if($page == 'C'){ echo form_open_multipart(base_url().'toolplaza/dsr/do_add', array('id' => 'add_dsr', 'method' => 'post')); } if($page == 'U'){ echo form_open_multipart(base_url().'toolplaza/dsr/do_update/'.$dsr['dsr'][0]['id'], array('id' => 'edit_dsr', 'method' => 'post')); } }?>
		<div class='container'>
			...
			<div class="row">	
				...
				<div class="col-md-3 form-group">
					<div class="col-md-12 pr-1 wrap-input-container">
						<span type="input" class="btn btn-info btn-block pull-right" onclick="<?php if(isset($page)){ if($page == 'C'){ echo "form_submit('add_dsr');"; } if($page == 'U'){  echo "form_submit('edit_dsr');"; } } ?>"><?php if($page == 'C'){ echo 'Submit';} if($page == 'U'){ echo 'Update';} ?></span>
