      ...
      <div class="content">
        ...
        <div class="col-md-6">
            <div class="card  card-tasks">
              <div class="card-header" style="background-color:rgba(0,0,0,.04)">
...
<script src="https://www.amcharts.com/lib/3/themes/light.js"></script><!-- Chart code -->
<?php if(!empty($chart)){ ?>
<script>
