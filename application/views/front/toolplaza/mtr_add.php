...
<div class="row">
  ...
  <div class="col-md-6 pr-1">
    ...
    <div class="form-group">
      <label>Month</label>
      <input type="text" class="form-control required" id="datePicker" name="for_month" placeholder="Choose Month and Year">
    </div>
  ...
  <div class="col-md-6 pr-1" id="demo">
    ...
    <div class="form-group">
      ...
      <Select class="form-control required" name="mtr_type" id="mtr_type">
        ...
        <option value="1">Standard(Complete Month)</option>
        <option value="2">Custom(For Specific Dates)</option>
      </select>
    </div>
  ...
  <div class="col-md-4 pr-1 wrap-input-container">
    ...
    <input class="file-upload form-control required" name="mtr_file" type="file" accept="application/pdf,image/*">
  </div>
...
<div class="row">
  ...
  <div class="col-md-12 pr-1 wrap-input-container">
    <span class="btn btn-info btn-block pull-right" onclick="form_submit('add_mtr');">Add</span>
  </div>
</div>
<?php echo form_close(); ?>
<script>
