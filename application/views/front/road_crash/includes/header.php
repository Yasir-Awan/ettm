    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <?php if($tpsupervisor[0]['role'] == 0 || $tpsupervisor[0]['role'] == 1 || $tpsupervisor[0]['role'] == 2){ ?>
          ...
          <?php } ?>
          <?php if($tpsupervisor[0]['role'] == 0 || $tpsupervisor[0]['role'] == 1 || $tpsupervisor[0]['role'] == 2){ ?>
          <li <?php if($page_name == 'dtr'){?>class="active"<?php } ?>>
            <a href="<?php echo base_url()?>toolplaza/dtr">
              <i class="now-ui-icons education_atom"></i>
              <p>Daily Traffic Report</p>
            </a>
          </li>
          <?php } ?>
          <?php if($tpsupervisor[0]['role'] == -1 || $tpsupervisor[0]['role'] == 1 || $tpsupervisor[0]['role'] == 2){ ?>
          <li <?php if($page_name == 'dsr'){?>class="active"<?php } ?>>
            <a href="<?php echo base_url()?>toolplaza/dsr">
              <i class="now-ui-icons education_atom"></i>
          ...
          <?php } else {} ?>
          <?php /* if($tpsupervisor[0]['role'] == -1 || $tpsupervisor[0]['role'] == 1 || $tpsupervisor[0]['role'] == 2){ ?>
          <li <?php if($page_name == 'supportrequest'){?>class="active"<?php } ?>>
            <a href="<?php echo base_url()?>toolplaza/supportrequest">
              <i class="now-ui-icons education_atom"></i>
              <p>Support Request</p>
            </a>
          </li>
