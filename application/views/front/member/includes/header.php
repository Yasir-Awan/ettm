...
<!--   <link rel="apple-touch-icon" sizes="76x76" href="../assets/img/apple-icon.png"> -->
  ...
  <title>
    ETTM MEMBER DASHBOARD
  </title>
  <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0, shrink-to-fit=no' name='viewport' />
  <!--     Fonts and icons     -->
  <link href="<?php echo base_url()?>assets/front/css/fonts.css" rel="stylesheet" />
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li <?php if($page_name == 'mtr'){?>class="active"<?php } ?>>
            <a href="<?php echo base_url()?>member/mtr">
              <i class="now-ui-icons design_app"></i>
              <p>Monthly Traffic Report</p>
            </a>
          </li>
          <li <?php if($page_name == 'inventory'){?>class="active"<?php } ?>>
            <a href="<?php echo base_url()?>member_inventory/first_page">
              <i class="now-ui-icons design_app"></i>
              <p>Inventory(items)</p>
            </a>
          </li>
          <li <?php if($page_name == 'map'){?>class="active"<?php } ?>>
            <a href="<?php echo base_url()?>member/map">
              <i class="now-ui-icons design_app"></i>
              <p>Map</p>
            </a>
          </li>
          <li <?php if($page_name == 'traffic_counting'){?>class="active"<?php } ?>>
            <a href="<?php echo base_url()?>member/traffic_counting">
              <i class="now-ui-icons design_app"></i>
              <p>Traffic Counting</p>
            </a>
          </li>
          <!-- <li>
            <a href="./icons.html">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            <?php if($page_name == "dashboard"){?>
             <?php echo form_open_multipart(base_url().'member/searchforchart', array('id' => 'searchforchart', 'method' => 'post'));?>
              <table>
                <tr>
                  <td>
                    <div class="input-group no-border">
                     <select class="form-control required" name="tollplaza" id="tollplaza" style="background-color: #5c7592;">
                 ...
                 <td>
                  <div class="input-group no-border date" style="display:none;">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="<?php echo base_url()?>member/settings"><i class="fa fa-wrench"></i>Settings</a>
                  <a class="dropdown-item" href="<?php echo base_url()?>member/logout"><i class="fas fa-sign-out-alt"></i>Logout</a>
                </div>
              </li>
