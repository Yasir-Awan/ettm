     ...
     <?php echo form_open_multipart(base_url().'member/mtr/do_update/'.$mtr[0]['id'], array('id' => 'edit_mtr', 'method' => 'post'));?>
                      ...
                      <div class="form-group" id="tp_check">
                       ...
                       <Select class="form-control required" name="tollplaza" id="tollplaza">
                            ...
                            <?php foreach($toolplaza as $tp){?>
                              <option value="<?php echo $tp['id']?>" <?php if($tp['id'] == $mtr[0]['toolplaza'])echo "selected";?>><?php echo $tp['name']?></option>
                            <?php } ?>
                        </select> 
                      </div>
                  ...
                  <?php if($mtr[0]['type'] == 2){?>
                        <div class="col-md-6 pr-1 start_date">
                              <div class="form-group">
                                  ...
                                  ?>
                                  <input type="text" name="start_date" id="start_date" class="form-control required" placeholder="Enter Start Date" value="<?php echo $start_date;?>" autocomplete="off">
                              </div>
                          <div></div>
                        </div>
                         ...
                         <div class="col-md-6 pr-1 end_date">
                              <div class="form-group">
                                  ...
                                  <input type="text" name="end_date" id="end_date" class="form-control required" placeholder="Enter End Date" value="<?php echo $end_date;?>" autocomplete="off">
                              </div>
