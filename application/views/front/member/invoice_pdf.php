                                ...
                                <div class="invoice-area">
                                            ...
                                            <div class="col-md-12">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span><h1 style="color: #030a10; font-size:26px; ">MONTHLY TRFFIC REPORT (MTR) SUMMARY FOR N.H.A</h1></span><br/>
                                                            <table>
                                                                ...
                                                                <tr style="text-align:center;">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        ?>
                                                                        <span style="font-size:18px;">(<?php echo date("F j, Y",strtotime($start_date));?>) TO (<?php echo date("F j, Y",strtotime($end_date));?>)</span>
                                                                        <?php }else{?>
                                                                                <span style="font-size:18px;"><?php echo date("F, Y",strtotime($mtr[0]['for_month']));?></span>
                                                                        <?php } ?>
                                    ...
                                    <div class="invoice-table table-responsive mt-5">
                                        <table class="table table-bordered table-hover" border="1px solid;" text-align="center">
                                            ...
                                            <tbody>
                                                <tr style="text-align:center;">
                                                    <td><div style="line-height:30px"><?php echo $mtr[0]['description'];?></div></td>
                                                    <td><div style="line-height:30px"><?php echo $mtr[0]['notes'];?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class1']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class2']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class3']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class4']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class5']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class6']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class7']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class8']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class9']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class10']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['total']);?></div></td>
                                                </tr>
                                                 <?php 
                                                    if($exempt){
                                                ?>
                                                ...
                                                <tr style="text-align:center;">
                                                   ...
                                                   <td><div style="line-height:30px"><?php echo number_format(($mtr[0]['class1'] - $exempt[0]['class1']) * $terrif[0]['class_1_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format(($mtr[0]['class2'] - $exempt[0]['class2']) * $terrif[0]['class_2_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format(($mtr[0]['class3'] - $exempt[0]['class3']) * $terrif[0]['class_3_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format(($mtr[0]['class4'] - $exempt[0]['class4']) * $terrif[0]['class_4_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format(($mtr[0]['class5'] - $exempt[0]['class5']) * $terrif[0]['class_5_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format(($mtr[0]['class6'] - $exempt[0]['class6']) * $terrif[0]['class_6_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format(($mtr[0]['class7'] - $exempt[0]['class7']) * $terrif[0]['class_7_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format(($mtr[0]['class8'] - $exempt[0]['class8']) * $terrif[0]['class_8_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format(($mtr[0]['class9'] - $exempt[0]['class9']) * $terrif[0]['class_9_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format(($mtr[0]['class10'] - $exempt[0]['class10'])* $terrif[0]['class_10_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format((($mtr[0]['class1'] - $exempt[0]['class1']) * $terrif[0]['class_1_value']) + (($mtr[0]['class2'] - $exempt[0]['class2']) * $terrif[0]['class_2_value']) + (($mtr[0]['class3'] - $exempt[0]['class3']) * $terrif[0]['class_3_value']) + (($mtr[0]['class4'] - $exempt[0]['class4']) * $terrif[0]['class_4_value']) + (($mtr[0]['class5'] - $exempt[0]['class5']) * $terrif[0]['class_5_value']) + (($mtr[0]['class6'] - $exempt[0]['class6']) * $terrif[0]['class_6_value']) + (($mtr[0]['class7'] - $exempt[0]['class7']) * $terrif[0]['class_7_value']) + (($mtr[0]['class8'] - $exempt[0]['class8']) * $terrif[0]['class_8_value']) + (($mtr[0]['class9'] - $exempt[0]['class9']) * $terrif[0]['class_9_value']) + (($mtr[0]['class10'] - $exempt[0]['class10']) * $terrif[0]['class_10_value']));?></div></td>
                                                    
                                                   <?php }else{?>
                                                    <td><div style="line-height:30px">Revenue</div></td>
                                                    <td><div style="line-height:30px"></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class1'] * $terrif[0]['class_1_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class2'] * $terrif[0]['class_2_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class3'] * $terrif[0]['class_3_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class4'] * $terrif[0]['class_4_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class5'] * $terrif[0]['class_5_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class6'] * $terrif[0]['class_6_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class7'] * $terrif[0]['class_7_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class8'] * $terrif[0]['class_8_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class9'] * $terrif[0]['class_9_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format($mtr[0]['class10'] * $terrif[0]['class_10_value']);?></div></td>
                                                    <td><div style="line-height:30px"><?php echo number_format(($mtr[0]['class1'] * $terrif[0]['class_1_value']) + ($mtr[0]['class2'] * $terrif[0]['class_2_value']) + ($mtr[0]['class3'] * $terrif[0]['class_3_value']) + ($mtr[0]['class4'] * $terrif[0]['class_4_value']) + ($mtr[0]['class5'] * $terrif[0]['class_5_value']) + ($mtr[0]['class6'] * $terrif[0]['class_6_value']) + ($mtr[0]['class7'] * $terrif[0]['class_7_value']) + ($mtr[0]['class8'] * $terrif[0]['class_8_value']) + ($mtr[0]['class9'] * $terrif[0]['class_9_value']) + ($mtr[0]['class10'] * $terrif[0]['class_10_value']));?></div></td>
                                               <?php } }else{?>
                                                    <td colspan="13"><div style="line-height:30px; color: #e60c0c;">Tarrif for this MTR is not added yet.</div></td>
                                               <?php }?>
                                                </tr>
