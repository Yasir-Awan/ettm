                      ...
                      <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                        ...
                        <div class="btn-group" role="group">
                          ...
                          <a class="dropdown-item submit" href="#"  value="Checkout" data-toggle="modal" data-target="#assets_checkout" onclick="ajax_html_cust('<?php echo base_url()?>inventory/action_on_asset/checkout/','checkout_asset_contents');"> Checkout</a>
                           ...
                           <a class="dropdown-item submit" href="#"  value="Repair" data-toggle="modal" data-target="#assets_repair" onclick="ajax_html_cust('<?php echo base_url()?>inventory/action_on_asset/start_repair/','start_repair_assets');">Start Repair</a>
                           <a class="dropdown-item submit" href="#"  value="Repair" data-toggle="modal" data-target="#assets_end_repair" onclick="ajax_html_cust('<?php echo base_url()?>inventory/action_on_asset/end_repair/','end_repair_assets');">End Repair</a>                           
                           ...
                           <a class="dropdown-item submit" href="#" id="submit" value="extend_checkout" data-toggle="modal" data-target="#assets_extend_checkout" onclick="ajax_html_cust('<?php echo base_url()?>inventory/action_on_asset/extend_checkout/','extendcheckout_asset_contents');" > Extend Checkout</a>
                           </div>
                         </div>
                       </div>
                       </div><!-- col-md-4 END -->
