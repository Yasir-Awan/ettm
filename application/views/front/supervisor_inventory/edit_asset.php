<?php echo form_open(base_url()."supervisor_inventory/edit_asset_do/".$asset[0]['id'],array('id' => 'edit_asset'));?>
          ...
          <script>
           $('#item_type_edit').change(function (){    
            var itemType = this.value;
             $.ajax({ 
              url: "<?php echo base_url() ?>member_inventory/asset_type/"+itemType,
              cache       : false,
              contentType : false,
              processData : false,
              beforeSend: function() {
