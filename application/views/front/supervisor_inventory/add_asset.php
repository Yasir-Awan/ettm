<?php echo form_open(base_url()."supervisor_inventory/add_asset_do/",array('id' => 'add_assets'));?>
                   <!-- Form Textual inputs start -->
        <div class="col-12 mt-0" style="padding:unset;">
         <div class="card">
           <div class="card-body">
                <fieldset style="">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <div class="row">
                      ...
                      <input type="hidden" class="form-control required" name="site_id" id="site_id"  value="<?php echo $site['id'];?>" >
                  ...
                  <div class="form-group">
                      <div class="row">
                         ...
                         <div class='col-md-4'>
                         <input type="date" class="form-control required" id="purchase_date" name="purchase_date" placeholder="Choose Purchasing Date">
                         </div>
                         <div class='col-md-2'>
