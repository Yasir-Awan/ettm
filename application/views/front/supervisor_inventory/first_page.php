                        ...
                        <div class="col-lg-12 shadow mb-1 mt-3 d-none d-lg-block">
                            <div class="horizontal-menu py-2 ">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="tab  nav-link " id="asset" data-toggle="tab" href="#installed" role="tab" aria-controls="installs" aria-selected="false" onclick="ajax_html('<?php echo base_url() ?>supervisor_inventory/tabs/installed/','displaying_installed');">Installed Items</a>
                                    </li>
