...
<?php 
              if($transactions){
        if($transactions[0]['transaction_type']!==1 && $transactions[0]['transaction_type']!==2 && $transactions[0]['transaction_type']!==3 && $transactions[0]['transaction_type']!==4 && $transactions[0]['transaction_type']!==5 && $transactions[0]['transaction_type']!==6 && $transactions[0]['transaction_type']!==7 && $transactions[0]['transaction_type']!==8 && $transactions[0]['transaction_type']!==9 && $transactions[0]['transaction_type']!==10 && $transactions[0]['transaction_type']!==11)
