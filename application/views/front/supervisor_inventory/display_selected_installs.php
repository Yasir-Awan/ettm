<div class="table-responsive ">
  ...
  <span align='center'>
    <h4 style="color: #030a10;" class='mb-3 mt-3'>Installed Item Comprihensive Detail</h4>
  </span>
  <br><br>
  <div class"row">
      ...
      <table class="table table-borderless">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span style="font-size: 0.80rem;color: #030a10;"><?php echo $asset['cost_price']; ?></span></td>
            ...
            <td><span style="font-size: 0.80rem;color: #030a10;"><?php echo $supplierName[0]['name']; ?></span></td>
            <th><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;">Manufecturer:</span></th>
          ...
          <tr>
            ...
            <td><span style="font-size: 0.80rem;color: #030a10;"><?php echo $site[0]['name']; ?></span></td>
            <th scope="row"><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;">Purchased On:</span></th>
            <?php $site = $this->db->get_where('sites', array('id' => $asset['site']))->result_array(); ?>
            <td><span style="font-size: 0.80rem;color: #030a10;"><?php echo date("F j, Y", strtotime($asset['purchased_on'])) ?></span></td>
          ...
          <tr>
            ...
            <th scope="row"><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;">This asset Added on:</span></th>
  ...
  <table class="table table-borderless">
    <thead>
      <tr>
        <span align='center'>
          <h5 style="color: #030a10; ">Asset Current Status</h5>
        </span>
      </tr>
    </thead>
    <tbody>
      <tr>
        <th scope="row"><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;">Current Status</span></th>
        <?php
        ...
        <?php if ($selected_assets[0]['action_status'] == 0) { ?>
          <th scope="row"><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;"><?php echo "No action performed on this Asset.";  ?></span></th>
        <?php } ?>
      ...
      <tr>
        ...
        <td><span style="font-size: 0.80rem;color: #030a10;"><?php echo $transaction['person_contact']; ?></span></td>
        ...
        <?php if ($transaction['issuance_type'] == 2) { ?>
          ...
          <td><span style="font-size: 0.80rem;color: #030a10;"><?php echo date("F j, Y", strtotime($transaction['return_date'])); ?></span></td>
        <?php } ?>
      ...
      <tr>
        ...
        <?php $supplierName = $this->db->get_where('suppliers', array('id' => $asset['supplier']))->result_array(); ?>
        <td> <span style="font-size: 0.80rem;color: #030a10;"> <?php echo date("F j, Y", strtotime($transaction['action_date'])); ?> </span> </td>
        <!-- <th><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;">Warranty Duration</span></th>
      <td><span style="font-size: 0.80rem;color: #030a10;margin-right: ;"><?php echo $asset['warranty_duration']; ?></span></td> -->
      </tr>
    <?php }
    ...
    ?>
      ...
      <tr>
        ...
        <td><span style="font-size: 0.80rem;color: #030a10;"><?php echo $transaction['organisation_address']; ?></span></td>
        <th scope="row"><span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;">Action Added on:</span></th>
        <?php $supplierName = $this->db->get_where('suppliers', array('id' => $asset['supplier']))->result_array(); ?>
        <td> <span style="font-size: 0.80rem;color: #030a10;"> <?php echo date("F j, Y", strtotime($transaction['action_date'])); ?> </span> </td>
      </tr>
