<div class="table-responsive col-md-2 emptydiv" style="display:none;">
</div>
    ...
    <div class="row">
      <div class="col-sm-12 pl-1 pr-1">
        ...
        <div class='row mb-1 mt-1'>
            ...
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
              ...
              <div class="btn-group" role="group">
                ...
                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                  <a class="dropdown-item submit" href="#" value="Faulty" data-toggle="modal" data-target="#installs_faulty" onclick="ajax_html_cust('<?php echo base_url() ?>supervisor_inventory/item_faulty_form/','start_faulty_installs');">Faulty</a>
                  <a class="dropdown-item submit" href="#" value="Repair" data-toggle="modal" data-target="#installs_repair" onclick="ajax_html_cust('<?php echo base_url() ?>supervisor_inventory/item_repair_form/','start_repair_installed');">Repair</a>
                  <a class="dropdown-item submit" href="#" value="Repair" data-toggle="modal" data-target="#installs_end_repair" onclick="ajax_html_cust('<?php echo base_url() ?>supervisor_inventory/item_reinstall_form/','end_repair_installed');">Reinstall</a>
                  <a class="dropdown-item submit" href="#" value="Retire" data-toggle="modal" data-target="#installs_retire" onclick="ajax_html_cust('<?php echo base_url() ?>supervisor_inventory/item_retire_form/','retire_installed_contents');"> Retire</a>
                </div>
              </div>
            </div>
          </div><!-- col-md-4 END -->
          ...
          <div class="col-md-2 by_location" style="display:none; padding: unset;">
            <select class="form-control required" id="location">
...
<script>
  ...
  $('body').on('change', '#location', function() {
    let loc = this.value;
    if (loc) {
      ajax_html('<?php echo base_url() ?>supervisor_inventory/installed_inventory/list/' + loc, 'displaying_installed');
    }
  });
</script>