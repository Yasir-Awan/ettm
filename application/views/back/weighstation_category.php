            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Vehicle Categories</h4>
                                <span class="btn btn-success btn-xs pull-right fa fa-plus" data-toggle="modal" data-target="#weighAdd" onclick="ajax_html('<?php echo base_url()?>admin/weighstation_categories/add/', 'addweigh_contents');">Add New Category</div>
...
<script>
    ...
    var user_type = 'admin';
    var module = 'weighstation_categories';
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url()?>admin/weighstation_categories/tp_publish_set/' + id + '/' +mode,
      cache       : false,
      contentType : false,
      processData : false,
...
$(document).ready(function(){
            $.ajax({ 
            url: "<?php echo base_url();?>admin/weighstation_categories/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
