                    ...
                    for ($general_counter = 0; $general_counter < $max_gen_data; $general_counter++) { ?>
                      <tr>
                        ...
                        ?>
                            ...
                            if ($gd[$td_counter][$general_counter]['transaction_type'] == 3 || $gd[$td_counter][$general_counter]['transaction_type'] == 9) {
                            ?>
                ...
                <?php if ($specificSite[0]['site_type'] == 1) { ?>
                  <tr scope="col">
                    ...
                    ?>
                        ...
                        ?>
                          <?php if ($row['transaction_type'] == 3 || $row['transaction_type'] == 9 || $row['transaction_type'] == 14) { ?>
                            <th colspan="6" style="background:#42c692;"><a href="#" style="font-family:cursive;color:white;" onclick="show_dashboard_details('<?php echo base_url() . 'inventory/selected_install/listfromdashboard/' . $row['identification_no']; ?>','display_installed_details');" data-toggle="modal" data-target="#inventoryModal"><?php echo $ptz[0]['name'];
                                                                                                                                                                                                                                                                                                                                                        $var = 'set'; ?></a></th>
                            <!-- <i class="fa fa-check"  style="color:green;"></i> -->
                          <?php } else { ?>
                            <th colspan="6" style="background:#ff7851;"><a href="#" style="font-family:cursive;color:white;" onclick="show_dashboard_details('<?php echo base_url() . 'inventory/selected_install/listfromdashboard/' . $row['identification_no']; ?>','display_installed_details');" data-toggle="modal" data-target="#inventoryModal"> <?php echo $ptz[0]['name'];
                                                                                                                                                                                                                                                                                                                                                          $var = 'set'; ?></a></th>
                    ...
                    if ($var == 'yasir') {
                      ?>
                      <th colspan="6">
                        <h4 class="text-info">PTZ Camera not installed in this bound yet!</h4>
                      </th>
                    <?php } ?>
                  </tr>
                <?php } ?>
                ...
                <?php if ($specificSite[0]['site_type'] == 1) { ?>
                  <tr scope="col">
                    ...
                    ?>
                        ...
                        ?>
                          <?php if ($row['transaction_type'] == 3 || $row['transaction_type'] == 9 || $row['transaction_type'] == 14) { ?>
                            <th colspan="6" style="background:#42c692;"><a href="#" style="color:white;" onclick="show_dashboard_details('<?php echo base_url() . 'inventory/selected_install/listfromdashboard/' . $row['identification_no']; ?>','display_installed_details');" data-toggle="modal" data-target="#inventoryModal"> <?php echo $ptzSouth[0]['name'];
                                                                                                                                                                                                                                                                                                                                      $var1 = 'ne'; ?></a></th>
                            <!-- <i class="fa fa-check"  style="color:green;"></i> -->
                          <?php } else { ?>
                            <th colspan="6" style="background:#ff7851;"><a href="#" style="color:whtie;" onclick="show_dashboard_details('<?php echo base_url() . 'inventory/selected_install/listfromdashboard/' . $row['identification_no']; ?>','display_installed_details');" data-toggle="modal" data-target="#inventoryModal"> <?php echo $ptzSouth[0]['name'];
                                                                                                                                                                                                                                                                                                                                      $var1 = 'ne'; ?></a></th>
                            <!-- <i class="fa fa-close"  style="color:red;"></i> -->
                          <?php } ?>
                      <?php  }
        ...
        <div class="card  card-tasks">
          <div class="card-header" class="card border-top-info shadow h-100 py-2" style=" padding-left:1rem; padding-right:1rem; padding-top:3px; border-top: .25rem solid #d0b192!important;">
            <div class='row '>
              ...
              <div class='col-md-1'>
                <h5 class="card-category text-warning" style='text-align: center; text-info:solid #d0b192 !important;'> <?php if (!empty($chart)) {
                                                                                                                          echo $chart['tollplaza'];
                                                                                                                        } ?> </h5>
              </div>
              <div class="col-md-1" style="color:black;">
