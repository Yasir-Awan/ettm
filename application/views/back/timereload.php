  ...
  <div class="row mb-2" style="margin-left:0px; margin-right:0px;">
    ...
    <div class="search-box pull-left col-xl-3 col-md-6 mb-1 " style="">
      <?php if ($page == "Dashboard") { ?>
        <?php $hidden = array('plaza_id' => $plaza_id, 'month' => $month); ?>
        <?php echo form_open_multipart(base_url() . 'admin/searchforchart', array('id' => 'searchforchart', 'method' => 'post'), $hidden); ?>
        ...
        <select class="form-control required text-primary mb-1" name="tollplaza" id="tollplaza" class="card border-left-primary shadow h-100 py-2" style="height: 35px !important; padding-bottom: 6px; padding-left: 5px; border-left: .25rem solid #4e73df!important;">
          ...
          <?php foreach ($tollplaza as $row) { ?>
            <option value="<?php echo $plaza_id; ?>"><?php echo $row['name']; ?></option>
          <?php } ?>
        </select>
        ...
        <div class="col-md-12 mb-2">
          <div class="card  card-tasks">
            <div class="card-header" class="card border-top-info shadow h-100 py-2" style=" padding-left:1rem; padding-right:1rem; padding-top:3px; border-top: .25rem solid #36b9cc!important;">
              <div class='row '>
                <div class="col-md-12">
                  <h4 class="card-title text-info" style="color:#303641 !important;">Traffic summary of <?php if (!empty($chart)) {
                                                                                                          echo $chart['tollplaza'];
                                                                                                        } ?> <?php if (!empty($chart)) {
                                                                                                                echo date("F, Y", strtotime($chart['month']));
                                                                                                              } ?></h4>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <th scope="col">Revenue</th>
                        <td colspan='6'>
                          <h2><?php echo 'Tarrif Not Added yet!'; ?></h2>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
          ...
          <div class="card  card-tasks">
            <div class="card-header" class="card border-top-info shadow h-100 py-2" style=" padding-left:1rem; padding-right:1rem; padding-top:3px; border-top: .25rem solid #36b9cc!important;">
              <div class='row '>
                ...
                <div class='col-md-4'>
                  <h5 class="card-category text-warning" style='text-align: center; text-info:solid #f6c23e !important;'> <?php if (!empty($chart)) {
                                                                                                                            echo $chart['tollplaza'];
                                                                                                                          } ?> </h5>
                </div>
      ...
      <script>
        ...
        var chart = AmCharts.makeChart("chartdiv2", {
          ...
          "dataProvider": [{
            ...
            <?php if (!empty($pre_month_chart['month'])) { ?> "value2": <?php echo $pre_month_chart['class1']['data']; ?>,
            <?php } ?>
            <?php if (!empty($pre_year_chart['month'])) { ?> "value3": <?php echo $pre_year_chart['class1']['data']; ?>,
            <?php } ?>
          }, {
            "year": "<?php echo $chart['class2']['label'] ?>",
            "value": <?php echo $chart['class2']['data']; ?>,
            <?php if (!empty($pre_month_chart['month'])) { ?> "value2": <?php echo $pre_month_chart['class2']['data']; ?>,
            <?php } ?>
            <?php if (!empty($pre_year_chart['month'])) { ?> "value3": <?php echo $pre_year_chart['class2']['data']; ?>,
            <?php } ?>
          }, {
            "year": "<?php echo $chart['class3']['label'] ?>",
            "value": <?php echo $chart['class3']['data']; ?>,
            <?php if (!empty($pre_month_chart['month'])) { ?> "value2": <?php echo $pre_month_chart['class3']['data']; ?>,
            <?php } ?>
            <?php if (!empty($pre_year_chart['month'])) { ?> "value3": <?php echo $pre_year_chart['class3']['data']; ?>,
            <?php } ?>
          }, {
            "year": "<?php echo $chart['class4']['label'] ?>",
            "value": <?php echo $chart['class4']['data']; ?>,
            <?php if (!empty($pre_month_chart['month'])) { ?> "value2": <?php echo $pre_month_chart['class4']['data']; ?>,
            <?php } ?>
            <?php if (!empty($pre_year_chart['month'])) { ?> "value3": <?php echo $pre_year_chart['class4']['data']; ?>,
            <?php } ?>
          }, {
            "year": "<?php echo $chart['class5']['label'] ?>",
            "value": <?php echo $chart['class5']['data']; ?>,
            <?php if (!empty($pre_month_chart['month'])) { ?> "value2": <?php echo $pre_month_chart['class5']['data']; ?>,
            <?php } ?>
            <?php if (!empty($pre_year_chart['month'])) { ?> "value3": <?php echo $pre_year_chart['class5']['data']; ?>,
            <?php } ?>
          }],
          // "legend": {},
          "valueAxes": [{
        ...
        var chart = AmCharts.makeChart("chartdiv3", {
          ...
          "dataProvider": [{
              ...
              <?php if (!empty($pre_month_revenue['month'])) { ?> "value2": <?php echo $pre_month_revenue['class1']['data']; ?>,
              <?php }
              if (!empty($pre_year_revenue['month'])) { ?> "value3": <?php echo $pre_year_revenue['class1']['data']; ?>,
              <?php } ?>
            }, {
              "year": "<?php echo $chart['class2']['label'] ?>",
              "value": <?php echo $revenue['class2']['data']; ?>,
              <?php if (!empty($pre_month_revenue['month'])) { ?> "value2": <?php echo $pre_month_revenue['class2']['data']; ?>,
              <?php }
              if (!empty($pre_year_revenue['month'])) { ?> "value3": <?php echo $pre_year_revenue['class2']['data']; ?>,
              <?php } ?>
            }, {
              "year": "<?php echo $chart['class3']['label'] ?>",
              "value": <?php echo $revenue['class3']['data']; ?>,
              <?php if (!empty($pre_month_revenue['month'])) { ?> "value2": <?php echo $pre_month_revenue['class3']['data']; ?>,
              <?php }
              if (!empty($pre_year_revenue['month'])) { ?> "value3": <?php echo $pre_year_revenue['class3']['data']; ?>,
              <?php } ?>
            },
            {
              "year": "<?php echo $chart['class4']['label'] ?>",
              "value": <?php echo $revenue['class4']['data']; ?>,
              <?php if (!empty($pre_month_revenue['month'])) { ?> "value2": <?php echo $pre_month_revenue['class4']['data']; ?>,
              <?php }
              if (!empty($pre_year_revenue['month'])) { ?> "value3": <?php echo $pre_year_revenue['class4']['data']; ?>,
              <?php } ?>
            },
            {
              "year": "<?php echo $chart['class5']['label'] ?>",
              "value": <?php echo $revenue['class5']['data']; ?>,
              <?php if (!empty($pre_month_revenue['month'])) { ?> "value2": <?php echo $pre_month_revenue['class5']['data']; ?>,
              <?php }
              if (!empty($pre_year_revenue['month'])) { ?> "value3": <?php echo $pre_year_revenue['class5']['data']; ?>,
              <?php } ?>
            }
          ],
          // "legend": {},
          ...
          "graphs": [{
            ...
            <?php }
            if (!empty($pre_year_revenue['month'])) { ?>, {
                "id": "g3",
