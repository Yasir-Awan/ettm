                ...
                <div class="col-xs-12 col-md-12">
                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <?php echo form_open_multipart(base_url().'admin/settings/update_basic_info', array('id' => 'update_basic_info', 'method' => 'post'));?>
                           <div class="row">
                              <div class="col-md-1"></div>
                                ...
                                <div class="col-md-8 pr-">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="username" class="form-control required" placeholder="Enter Username" value="<?php echo $user[0]['username']?>">
                                  </div>
                                </div>
                                <div class="col-md-3"></div>
                                <div class="col-md-12">
                                    <span class="btn btn success pull-right" onclick="form_submit('update_basic_info');" style="margin-right:2%; color: white; background-color:#1a385c;">Update</span>
                                </div>
                            </div>
                        <?php echo form_close();?>
                    </div>
