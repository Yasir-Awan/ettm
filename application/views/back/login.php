    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box ptb--100">
                <?php echo form_open(base_url().'admin/do_login',array('id' => 'login'));?>
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="submit-btn-area">
                            <span id="form_submit" class="btn btn-primary btn-lg" onclick="form_submit('login');">Submit <i class="ti-arrow-right"></i></span>
