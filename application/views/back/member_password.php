<div class="row">
  <div class="col-md-12">
        <?php echo form_open(base_url()."admin/update_member_password/".$member_id,array('id' => 'update_member_pass'));?>
    ...
    <span class="btn btn-primary pull-right btn-xs" onclick="form_submit('update_member_pass');">Update</span>
