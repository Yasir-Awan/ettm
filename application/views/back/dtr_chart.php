...
chart.data = [
	<?php 
		$i = 1;
		if($chart['traffic'][$i]['data']){
			foreach($dtr as $id){
				
	?>
				{			
				  "date": "<?php echo $chart['traffic'][$i]['label']; ?>",
				  "traffic": <?php echo $chart['traffic'][$i]['data']; ?>,
				},
	<?php	
				$i++;
			}
...
chart.data = [
	<?php 
		$i = 1;
		if($revenue['revenue'][$i]['data']){
			foreach($dtr as $id){
				
	?>
				{			
				  "date": "<?php echo $revenue['revenue'][$i]['label']; ?>",
				  "revenue": <?php echo $revenue['revenue'][$i]['data']; ?>,
				},
	<?php	
				$i++;
			}
...
<!-- HTML -->
<div class="chart_div1" style="margin-top: -10px !important;">
 <!-- Content row Start-->
    ...
    <div class="card-body" style="padding: 1% !important;">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2" style="padding-left: 8%;">
          ...
          <div class="h5 mb-0 font-weight-bold text-gray-800" style="font-size: 16px;"><?php if(!empty($chart)){  echo date("j F, Y",strtotime($chart['ltraffic'][0]['date'])); } ?></div>
        </div>
    ...
    <div class="card-body" style="padding: 1% !important;">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2" style="padding-left: 8%;">
          ...
          <div class="h5 mb-0 font-weight-bold text-gray-800" style="font-size: 16px;"><?php if(!$exempt){echo $chart['ltraffic'][0]['total'];}else{echo 'Exempt is added';};?></div>
        </div>
