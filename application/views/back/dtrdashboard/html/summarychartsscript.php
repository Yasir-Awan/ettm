<style type="text/css">
	#allchartsummary1<?php echo $duration ?> {
		height: 500px;
	}	
</style>
...
<script type="text/javascript">
	...
	var chart = am4core.create("allchartsummary1<?php echo $duration ?>", am4charts.XYChart);
...
<style type="text/css">
	#allchartsummary2<?php echo $duration ?> {
		height: 500px;
	}	
</style>
<script src="<?php echo base_url()?>assets/amcharts4/core.js"></script>
...
<script>
	...
	// Create chart instance
	var chart = am4core.create("allchartsummary2<?php echo $duration ?>", am4charts.XYChart);
