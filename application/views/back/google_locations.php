                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="btn btn-success btn-xs pull-right fa fa-plus" href="<?php echo base_url()?>admin/googlelocations/add" />Add New Location </a></div>
                                <?php } ?>
...
<script>
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url()?>admin/googlelocations/tp_publish_set/' + id + '/' +mode,
      cache       : false,
      contentType : false,
      processData : false,
...
$(document).ready(function(){
            $.ajax({ 
            url: "<?php echo base_url();?>admin/googlelocations/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
