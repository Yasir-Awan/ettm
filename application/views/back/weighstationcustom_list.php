...
<div class="data-tables datatable-dark">
    <span class="btn btn-xs btn-primary fa fa-angle-double-left pull-right" style="font-size: 0.75em !important;margin-bottom: 1%;"onclick="load_default('<?php echo base_url()?>admin/weighstation/list/', 'list','custom_search','dynamic-input');">Back to list</span>
        ...
        <tbody>
            ...
            ?>
             <tr>
                ...
                <td><span class="badge badge-danger"><?php echo $row['routename'];?><span></td>
                <td><?php if($row['loc'] == 1){
                    echo '<span class="badge badge-info" style="background-color: #c713ca;">Motorway</span>';

                }else{
                    echo '<span class="badge badge-info" style="background-color: #36c3b6;">National Highway</span>';
                };?>
                </td>
            ...
            //echo 'else'.$row['status'];
                ...
                <td>
                    ...
                    <span class="btn btn-danger btn-sm  fa fa-trash" style="margin-top: 3%;" onclick="delete_confirm('Really want to delete This','<?php echo $row['id']; ?>')">Delete</span>
