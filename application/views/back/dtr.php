                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        <h4 class="header-title">Daily Traffic Reports</h4>
                                    </div>
                                    <div class="col-md-4">
...
$('body').on('change', '#toll_plaza', function (){
    ...
    //if(tollplaza){
        $.ajax({ 
            url: "<?php echo base_url();?>admin/dtr/by_tollplaza/"+tollplaza,
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
...
$(document).ready(function(){
            $.ajax({ 
            url: "<?php echo base_url();?>admin/dtr/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Dissapprove Daily Traffic Report</h5>
