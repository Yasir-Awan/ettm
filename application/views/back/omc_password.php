<div class="row">
  <div class="col-md-12">
        <?php echo form_open(base_url()."admin/update_omc_password/".$omc_id,array('id' => 'update_omc_pass'));?>
    ...
    <span class="btn btn-primary pull-right btn-xs" onclick="form_submit('update_omc_pass');">Update</span>
