                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <span class="btn btn-success btn-xs pull-right fa fa-plus" data-toggle="modal" data-target="#memberAdd" onclick="ajax_html('<?php echo base_url()?>admin/member_add/', 'memberAdd_contents');">Add New Member</span>
                                <?php } ?> 
...
<script>
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url()?>admin/member/tps_publish_set/' + id + '/' +mode,
      cache       : false,
      contentType : false,
      processData : false,
...
$(document).ready(function(){
            $.ajax({ 
            url: "<?php echo base_url();?>admin/member/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
...
<div class="modal fade" id="memberPass">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Change Member Password</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
              <div id="memberPass_contents">
              </div>  
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
