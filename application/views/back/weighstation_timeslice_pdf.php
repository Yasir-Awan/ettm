          ...
          <?php 
            $weighstation_name = $this->db->get_where('weighstation',array('id' => $timeSliceData[0]['weigh_id']))->row()->name;
          ?>
            <!-- page title area end -->
                         <table>
                        <tr>
                            ...
                            <td width="60%"><div style="text-align:center;">
                                <br><br>
                                <span><h1 style="color: #030a10; font-size:16px;">Time Slice Report</h1></span><br/>
                                <table>
                                    <tr style="text-align:center;">
                                        ...
                                        <td width="60%" text-align="left">
                                            <span style="font-size:14px;text-align:left"><?php echo date("F j, Y", strtotime($timeSliceData[0]['date']));?></span>
                                        </td>
                                    </tr>                                        
                        </table>
                        </div>
