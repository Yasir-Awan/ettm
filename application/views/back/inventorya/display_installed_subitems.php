                      ...
                      <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                        ...
                        <div class="btn-group" role="group">
                          ...
                          <!-- <a class="dropdown-item submit" href="#"  value="Checkout" data-toggle="modal" data-target="#assets_checkout" onclick="ajax_html_cust('<?php echo base_url()?>inventory/action_on_asset/checkout/','checkout_asset_contents');"> Checkout</a>
                           ...
                           <a class="dropdown-item submit" href="#"  value="Repair" data-toggle="modal" data-target="#component_repair" onclick="ajax_html_cust('<?php echo base_url()?>inventory/action_on_asset/component_start_repair/','start_repair_comp');">Repair</a>
