    ...
    <div class="card shadow mb-1 mt-3">
       ...
       <div class="col-lg-12  d-none d-lg-block">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="tab  nav-link " id="asset" data-toggle="tab" href="#assets" role="tab" aria-controls="assets" aria-selected="false" >Assets</a>
                                    </li>
                                    <li class="nav-item">
...
$(document).ready(function(){
            ...
            $.ajax({ 
            url: "<?php echo base_url();?>inventory/specific_asset/list/<?php echo $asset_id ?>",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
