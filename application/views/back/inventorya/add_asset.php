         ...
         <div class="card">
           <div class="card-body">
              ...
              <div class='row'>
               ...
               <input type="hidden" class="form-control required" id="quantity" name="quantity" placeholder="Enter Quantity" min="1"> 
               </div>
               </div>
                </div>  -->
                ...
                <div class="form-group">
                  <div class='row'>
                    ...
                    <div class='col-md-4'>
                    <input value="0.00"  class="custom-select form-control " maxlength="13" step="0.01" min="0" size="13" type="text" name="asset_price" id="asset_price">
                    </div>
                  </div>
                </div>  
