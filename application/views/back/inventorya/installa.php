<?php echo form_open(base_url()."inventory/action_on_asset/install_do/",array('id' => 'install'));?>
        <div class="form-group">
          ...
          <div class="form-group installing_location" style="display:none; margin-left:35%;">
      <label for="exampleInputEmail1" style="font-weight: 900;">Location</label>
      <span class="asterisk" data-original-title="" title="">*</span>
      <select name="location[]"  class="form-control required" multiple="multiple" data-placeholder="Choose Location" tabindex="-1" data-hide-disabled="true" id="site_locations" style=" width: 85%;">
