<?php echo form_open(base_url()."inventory/action_on_asset/checkout_do/",array('id' => 'checkout'));?>     
          ...
          <script>
           $('body').on('change', "#employeetype", function (){    
            var userRole = this.value;
             $.ajax({ 
              url: "<?php echo base_url() ?>inventory/action_on_asset/change_role/"+userRole,
              cache       : false,
              contentType : false,
              processData : false,
              beforeSend: function() {
