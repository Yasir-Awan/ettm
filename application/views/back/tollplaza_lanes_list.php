        ...
        <tbody>
            <?php if($lanes){
                ...
                foreach($lanes as $row){
                    $tollplaza = $this->db->get_where('toolplaza',array('id' => $row['toll_plaza']))->row()->name;
                      $counter++;
            ...
            ?>
             <tr>
                ...
                <td>
                 ...
                 <?php if($this->session->userdata('role') == 1) {?>
                <td>
                    <span class="btn btn-success btn-sm btn-labeled fa fa-edit" id="cancel_reason" name="tp_edit" onclick="ajax_html('<?php echo base_url().'admin/tollplaza_lanes/edit/'.$row['id'];?>','edit_toolplazalanes_contents');" data-toggle="modal" data-target="#edit_toolplazalanes">&nbsp;Edit</span>
