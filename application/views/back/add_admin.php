<div class="row">
  <div class="col-md-12">
        <?php echo form_open(base_url()."admin/add_admin_do/",array('id' => 'add_admin'));?>
    ...
    <span class="btn btn-primary btn-xs" style="margin-left:700px;" onclick="form_submit('add_admin');">Add</span>
