...
<!-- Hidden Form END -->
        ...
        <?php if($page == "Desired Chart"){?>
             ...
             <?php echo form_open_multipart(base_url().'omc/searchfordesiredchart', array('id' => 'searchfordchart', 'method' => 'post'));?>
...
<!-- Traffic summary table -->
 <div class="col-md-12 mb-1">
            ...
            <div class="card-header" class="card border-top-info shadow h-100 py-1" style=" padding-left:1rem; padding-right:1rem; padding-top:3px; border-top: .25rem solid #36b9cc!important;">
               <div class='row '>
                    <div class="col-md-12">
                    <h4 class="card-title text-info" style="color:#303641 !important; margin-bottom:0 !important;" >Traffic summary of  <?php if(!empty($chart)){ echo $chart['tollplaza'];}?>  <?php if(!empty($chart)){ echo date("F, Y",strtotime($chart['month'])); } ?></h4>
                    </div>
...
<!-- Traffic summary Table END -->
          ...
          <div class="col-md-6 mb-0">
            <div class="card  card-tasks">
            <div class="card-header" class="card border-top-info shadow h-100 py-1" style=" padding-left:1rem; padding-right:1rem; padding-top:2px; border-top: .25rem solid #36b9cc!important;">
               <div class='row '>
                    <div class="col-md-4">
        ...
        <div class="col-md-6 mb-0">
            <div class="card  card-tasks">
            <div class="card-header" class="card border-top-info shadow h-100 py-1" style=" padding-left:1rem; padding-right:1rem; padding-top:2px; border-top: .25rem solid #1cc88a!important;">
               <div class='row '>
                    <div class="col-md-4">
         ...
         <!--Pie chart Traffic-->
          <div class="col-md-6 mb-0">
            <div class="card  card-tasks">
            <div class="card-header" class="card border-top-info shadow h-100 py-1" style=" padding-left:1rem; padding-right:1rem; padding-top:6px; border-top: .25rem solid #36b9cc!important;">
               <div class='row '>
                    <div class="col-md-4">
                    <h4 class="card-title text-info" >Traffic </h4> 
                    </div>
              ...
              <div class="card-body " style="margin-left:-37px;">
                <div id="chartdiv"></div>
              </div>
...
<!-- Pie chart Revenue -->
          <div class="col-md-6 mb-0">
            ...
            <div class="card-header" class="card border-top-info shadow h-100 py-1" style=" padding-left:1rem; padding-right:1rem; padding-top:2px; border-top: .25rem solid #1cc88a!important;">
              ...
              <div class="card-body " style="margin-left:-42px; ">
        ...
        <div class="col-md-6">
            <div class="card  card-tasks">
            <div class="card-header" class="card border-top-info shadow h-100 py-2" style=" padding-left:1rem; padding-right:1rem; padding-top:2px; border-top: .25rem solid #36b9cc!important;">
               <div class='row '>
                    <div class="col-md-4">
                    <h4 class="card-title text-info" >Traffic </h4> 
                    </div>
              ...
              <div class="card-body " style="margin-left:-25px; padding: none !important;">
