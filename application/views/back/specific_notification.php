<?php include('includes/header.php'); ?>
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        <h4 class="header-title"><?php if(isset($name)){ echo $name; }else{ echo 'Notifications';} ?></h4>
                                    </div>
                                    <div class="col-md-4">
    ...
    var user_type = 'admin';
    var module = 'specific_notification';
...
$(document).ready(function(){
            $.ajax({ 
            url: "<?php echo base_url();?>admin/specific_notification/list/<?php echo $not_id ?>",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
