...
<div class="row">
  <div class="col-md-12">
        <?php echo form_open(base_url()."admin/dtr/disapprove_do/".$dtr_id,array('id' => 'dissapprove'));?>
    ...
    <span class="btn btn-primary pull-right btn-xs" onclick="form_submit('dissapprove');">Update DTR</span>
