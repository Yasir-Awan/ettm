...
?>   */?>
                 ...
                 <?php if($this->session->userdata('role') == 1) {?>
                <td>
                    <span class="btn-success btn-xs btn-labeled fa fa-edit" id="cancel_reason" name="tp_edit" onclick="ajax_html('<?php echo base_url().'admin/admin_edit/'.$row['id'];?>','editadmin_contents');" data-toggle="modal" data-target="#editadmin">&nbsp; Edit</span>
                    <span class="btn-info btn-xs btn-labeled fa fa-wrench" id="cancel_reason" name="tp_edit" onclick="ajax_html('<?php echo base_url().'admin/admins_password/'.$row['id'];?>','adminPassword_contents');" data-toggle="modal" data-target="#adminPassword">&nbsp;Change Password</span>
