<div class="row">
	<div class="col-md-12">
		<?php if(isset($features)){ echo form_open(base_url()."admin/dsr_features/update/".$features[0]['id'],array('id' => 'edit_dsr_feature')); } else{ echo form_open(base_url()."admin/dsr_features/add_do/",array('id' => 'add_dsr_feature')); }?>
		...
		<div class="form-group">
			...
			<select name="type" id="add-options" class="form-control required">
				...
				<option value="4" <?php if(isset($features)){ if($features[0]['type'] == 4){ echo 'selected';} }?> >Time</option>
			</select>
		</div>
