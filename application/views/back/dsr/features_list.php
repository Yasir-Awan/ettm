    ...
    <table id="dataTable3" class="text-center">
        ...
        <tbody>
			...
			<tr>
				...
				<?php if($this->session->userdata('role') == 1) {?>
				<td>
					<span class="btn btn-success btn-sm btn-labeled fa fa-edit" id="cancel_reason" name="dsr_feature_edit" onclick="ajax_html('<?php echo base_url().'admin/dsr_features/edit/'.$row['id'];?>','edit_dsr_feature_contents');" data-toggle="modal" data-target="#dsr_feature_edit">&nbsp;Edit</span>
