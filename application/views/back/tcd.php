                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="pull-right">
									<span class="btn btn-success border-none" data-toggle="modal" data-target="#tcdAdd" onclick="ajax_html('<?php echo base_url()?>admin/tcd/add/', 'tcdAdd_contents');">Add New Report</span>
								</div>
...
<div class="modal fade" id="tcdAdd">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Traffic Counter Report</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
              <div id="tcdAdd_contents">
              </div>  
            </div>
...
<div class="modal fade" id="tcdEDIT">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Traffic Counter Report</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
              <div id="tcdEDIT_contents">
              </div>  
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="dissaprove">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Dissapprove Daily Site Report</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
