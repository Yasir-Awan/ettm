<div class="page-title-area" style='line-height=0%' >
                ...
                <div class="row align-items-center" >
					...
					<div class="breadcrumbs-area clearfix"style='margin-top:12px;'>
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                {	
                                ?>
                                <a href="<?php echo base_url().'weighstations';?>">Home</a>
                                <?php
                                }
								?>
                                </li>
                ...
                {	
                ?>
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> Weigh User</span>
                <?php } ?>
                ...
                <?php if($this->session->userdata('weighsupr_id')){ ?>
                <a class="dropdown-item" href="#">
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                  Profile
                </a>
                <a class="dropdown-item" href="<?php echo base_url()?>weighstations/settings">
                ...
                {	
                ?>
                <a class="dropdown-item" href="<?php echo base_url()?>weighstations/logout" >
