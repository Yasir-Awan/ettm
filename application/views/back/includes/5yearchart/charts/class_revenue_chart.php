...
chart.data = [<?php for($y = 1; $y < $duration; $y++){ ?>{
	...
	"<?php echo $name[$class] ?>": "<?php echo $total_revenue_class[$y][$class] ?>",
	<?php } ?>
...
valueAxis.title.text = "Revenue Classification on Class";
...
series<?php if($class !=1){echo $class;} ?>.columns.template.tooltipText = "<?php echo $name[$class]; ?> Revenue in {year}: [bold]{valueY}[/]";
