                    ...
                    <nav>
                        ...
                        <hr class="sidebar-divider" style="    border-top: 1px solid rgba(255,255,255,.15);" >
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li <?php if($page == 'dtrchart')echo "class='active'";?>>
										<a style="color:#fff;" href="<?php echo base_url();?>admin/dtrchart" aria-expanded="true" ><i style="color:#fff;" class="ti-dashboard"></i><span>Daily Graph</span></a>
									</li>
                            ...
                            <li>
                                <a style="color:#fff;" href="<?php echo base_url();?>admin" aria-expanded="true" ><i style="color:#fff;" class="fa fa-group"></i><span>Advanced</span></a>
                                <ul class="collapse">
                                	...
                                	<li <?php if($page == 'Toll Plaza Staff')echo "class='active'";?>><a style="color:#fff;" href="<?php echo base_url()?>admin/tpstaff"><i style="color:#fff;" class="fa fa-group"></i> <span>Toll Plaza Staff</span></a></li>
