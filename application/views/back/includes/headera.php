...
<head>
    ...
    <link href="<?php echo base_url()?>assets/back/chosen/chosen.css" rel="stylesheet">
    <link href="<?php echo base_url()?>assets/back/chosen/chosen.min.css" rel="stylesheet">
    <script src="<?php echo base_url();?>assets/back/chosen/chosen.jquery.js" type="text/javascript"></script>
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
                        ...
                        <div class="nav-btn pull-left" style='margin-top:10px;'>
                            <span></span>
                            <span></span>
                            <span></span>
                        </div>
