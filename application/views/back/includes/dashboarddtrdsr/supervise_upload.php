		...
		<div class="card-body">
			<div class="media">
				<div class="media-middle media-body">
                    ...
                    <!-- <span>Please Click on a DTR or DSR button first</span> -->
					<div class="row">
						<div class="col-md-12">
							<table>
								<thead>
								...
								<tbody>
									<tr>
										...
										<td><input class="form-control" autocomplete="off" value="<?php set_value("from_date") ?>" id="from_date" name="from_date"></td>
										<td><input class="form-control" autocomplete="off" value="<?php set_value("to_date") ?>" id="to_date" name="to_date"></td>
										...
										<td><input type="submit" class="btn btn-primary" onclick="form_submit('all_dates')" formtarget="_self"></td>
										<?php echo form_close(); ?>
