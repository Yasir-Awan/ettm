                ...
                <nav>
                        ...
                        <hr class="sidebar-divider" style="    border-top: 1px solid rgba(255,255,255,.15);" >
                            ...
                            <?php if($this->session->userdata('role')==1){ ?>
                                ...
                                <li <?php if($page == 'Weighstation'|| $page == 'consolidated'  || $page == 'weighstation custom data'|| $page == 'Weighstation Category' || $page == 'Weightlimit' || $page == 'weighstation daily report'){echo "class='active'";}?>>
                                ...
                                <li <?php if($page == 'weighstation daily report'){echo "class='active'";}?> style="line-height:10px;"><a href="<?php echo base_url()?>admin/weighstation_dashboard" ><i style="color:#fff;" class="ti-dashboard"></i> &nbsp; Dashboard</a></li>
                                    ...
                                    <li <?php if($page == 'Cameras List'){echo "class='active'";}?> style="line-height:10px;"><a href="<?php echo base_url()?>admin/CamerasList" ><i style="color:#fff;" class="fa fa-video"></i> &nbsp;Cameras List</a></li>
                                   <li  style="line-height:10px;"><a href="http://58.27.164.141/nha/admin/weighstation_dashboard"> <i style="color:#fff;" class="fa fa-balance-scale"></i> &nbsp;Dashboard2</a></li>
                                    ...
                                    <li <?php if($page == 'consolidated'){echo "class='active'";}?> style="line-height:10px;"><a href="<?php echo base_url()?>admin/weighstation_consolidated_report"> <i style="color:#fff;" class="fa fa-file"></i> &nbsp;Consolidated Report</a></li>                                    
                                    ...
                                    <li <?php if($page == 'consolidated'){echo "class='active'";}?> style="line-height:10px;"><a href="<?php echo base_url()?>admin/WeighCompany"> <i style="color:#fff;" class="fa fa-file"></i> &nbsp;Add Weigh Users</a></li>
                                </ul>
                            </li>
                            ...
                            <li <?php if($page == 'dashboard_live' || $page == 'Tollplaza_lanes' || $page == 'Tollplaza_live' || $page == 'Tollplaza report'){echo "class='active'";}?>>
                                ...
                                <ul class="collapse" <?php if($page == 'dashboard_live' || $page == 'Tollplaza_lanes' || $page == 'Tollplaza_live' || $page == 'Tollplaza report'){echo "-in";}?>>
                                    <li <?php if($page == 'dashboard_live'){echo "class='active'";}?> style="line-height:10px;"><a href="<?php echo base_url()?>admin/dashboard_live"> <i style="color:#fff;" class="fas fa-building"></i> &nbsp;Dashboard</a></li>
                        ...
                        <a style="color:#fff;" href="<?php echo base_url();?>admin/dashboard_dtr" aria-expanded="true" ><i style="color:#fff;" class="ti-dashboard"></i><span> DTR Overall</span></a>
                            ...
                            <!-- <li <?php if($page == 'crash_data')echo "class='active'";?>><a style="color:#fff;" href="<?php echo base_url()?>admin_crash"><i style="color:#fff;" class="fas fa-road"></i> <span>Road Crash Data</span></a></li> -->
                             <li>
                                ...
                                <ul class="collapse <?php if(isset($page)) if( $page == 'traffic_counting' || $page == 'Sensors Traffic Counting' || $page == 'traffic_entry'){echo 'in';}?>">
