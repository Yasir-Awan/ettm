   ...
   $this->db->update('notifications',array('is_read'=>1));
    ...
    <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false" style=" padding: 10px; width: max-content;" >
      <div class="toast-header">
        ...
        <strong class="mr-auto">MTR Updated</strong>
        <small class="text-muted">just now</small>
        <button type="button" class="ml-2  close" onclick="delete_notification('<?php echo base_url()?>admin/delete_notification/','<?php echo $row->id ?>');" data-dismiss="toast" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="toast-body">
		<a href="<?php echo base_url()?>admin/specific_mtr/<?php echo $row->ref_id ?>/" style="color:black;" ><?php echo "&nbsp&nbsp".$row->notification_msg;?> </a>	
      </div>
    </div>
    ...
    <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false" style="padding: 10px;width: max-content;">
      ...
      <div class="toast-body">
      <a href="<?php echo base_url()?>inventory/specific_asset/<?php echo $row->ref_id ?>/" style="color:black;" ><?php echo "&nbsp&nbsp".$row->notification_msg;?> </a>
      </div>
    </div>
  </div>
</div>
