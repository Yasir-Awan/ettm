                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                            ...
                                            <div class="iv-right col-6 text-md-right">
                                                ...
                                                <div class"row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <span class="text-left" style="font-size: 0.80rem;color: #030a10;float: left;margin-left: 20%;">Date</span><span style="font-size: 0.80rem;color: #030a10;margin-right: 10%;"><?php echo date("j F, Y",strtotime($dtr[0]['for_date']));?></span>
                                                       <!-- <?php if($dtr[0]['type'] == 2){
                                ...
                                <a href="<?php echo base_url()?>admin/dtr_generate_pdf/<?php echo $dtr[0]['id'];?>" class="btn btn-info pull-right"><i class="fa fa-file-pdf-o"></i> &nbsp;Generate PDF</a>
                            </div>
                        </div>
                    </div>
                </div>
