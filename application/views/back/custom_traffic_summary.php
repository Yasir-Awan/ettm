                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3">
                                        <h4 class="header-title">Custom Traffic Summary</h4>
                                    </div>
                                    <div class="col-md-9">
                                        <form method="post" action="<?php echo base_url().'admin/traffic_summary_custom/search_data';?>" id="search_custom">
                                        <table class="table">
                                            <tr>
                                                <td>
                                                    <div>
...
<script>
    ...
    $('body').on('change', '#toll_plaza', function (){
        ...
        if(tollplaza){
            $.ajax({ 
                url: "<?php echo base_url();?>admin/traffic_summary_custom/get_dates/"+tollplaza,
                cache       : false,
                contentType : false,
                processData : false,
                beforeSend: function() {
