...
<div class="row">
  <div class="col-md-12">
        <?php echo form_open(base_url()."admin/mtr/disapprove_do/".$mtr_id,array('id' => 'dissapprove'));?>
    ...
    <span class="btn btn-primary pull-right btn-xs" onclick="form_submit('dissapprove');">Update Mtr</span>
