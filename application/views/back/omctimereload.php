...
<div class="search-box pull-left col-xl-3 col-md-6 mb-1 " style="">
             ...
             <?php echo form_open_multipart(base_url().'omc/searchforchart', array('id' => 'searchforchart', 'method' => 'post'),$hidden);?>
...
<?php } ?>
   ...
   <?php $hidden = array('plaza_id' => $chart['toolplaza_id'], 'month' => $chart['month']); ?> 
      <?php echo form_open_multipart(base_url().'omc/dashboard_timer', array('id' => 'timer', 'method' => 'post'),$hidden);?> 
