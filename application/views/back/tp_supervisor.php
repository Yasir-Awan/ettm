            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Toll Plaza Supervisors</h4>
                                <?php if($this->session->userdata('role') == 1) {?>
                                <span class="btn btn-success btn-xs pull-right fa fa-plus" data-toggle="modal" data-target="#tpAdd" onclick="ajax_html('<?php echo base_url()?>admin/toolplaza_supervisor_add/', 'addtoolplaza_contents');">Add New Supervisor</div>
                                <?php  } ?>
...
<script>
    ...
    var user_type = 'admin';
    var module = 'toolplaza_supervisor';
...
$(document).ready(function(){
            $.ajax({ 
            url: "<?php echo base_url();?>admin/toolplaza_supervisor/list",
            cache       : false,
            contentType : false,
            processData : false,
            beforeSend: function() {
