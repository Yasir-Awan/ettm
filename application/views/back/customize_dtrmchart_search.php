...
<!-- Styles -->
<?php $i = 1; foreach($toll as $tollplaza){ if($tollplaza){ ?>



<style>

#chartdiv00<?php echo $i ?>{
  width: 100%;
  height: 500px;
}
#chartdiv000<?php echo $i ?>{
	width: 100%;
	height: 500px;
}
</style>
...
var chart = am4core.create("chartdiv00<?php echo $i; ?>", am4charts.XYChart);
...
var chart = am4core.create("chartdiv000<?php echo $i; ?>", am4charts.XYChart);
...
<!--Revenue Start End-->
<!-- HTML -->
<div class="row mb-2" style="margin-left:0px; margin-top:30px; margin-right:0px;">

<!--<div class='chart_div1' style="margin-top: -10px !important;"></div>-->
				...
				<div class="card card-tasks">
					<div class="card-header border-top-info shadow h-100 py-1" style=" padding-left:1rem; padding-right:1rem; padding-top:2px; border-top: .25rem solid #36b9cc!important;">
						<div class="row">
							...
							<div class="col-md-4">
								<h6 class="pull-right"><?php echo date("F, Y",strtotime($month))?></h6>
							</div>
						</div>
					</div>
					<div class="card-body">
						<div id="chartdiv00<?php echo $i ?>"></div>
					</div>
				</div>	
		</div>
		<div class="col-md-12">			
				<div class="card card-tasks">
					...
					<div class="card-body">
						<div id="chartdiv000<?php echo $i ?>"></div>
					</div>
				</div>	
		</div>
	</div>	
