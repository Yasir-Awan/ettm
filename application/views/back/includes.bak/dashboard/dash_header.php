...
<head>
  ...
  <!--link href="<?php echo base_url();?>assets/admin_logout_css/sb-admin-2.min.css" rel="stylesheet"-->
                ...
                <div class="menu-inner">
                    <nav>
                        ...
                        <hr class="sidebar-divider" style="    border-top: 1px solid rgba(255,255,255,.15);" >
                            ...
                            <li  <?php if($page == 'Tollplaza')echo "class='active'";?>><a style="color:#fff;" href="<?php echo base_url()?>admin/tollplaza"><i style="color:#fff;" class="fa fa-map-marker"></i> <span>Toll Plaza</span></a></li>
                            <!--li <?php if($page == 'Weighstation')echo "class='active'";?>>
                            <a style="color:#fff;" href="<?php echo base_url()?>admin/weighstation"><i style="color:#fff;" class="fa fa-balance-scale"></i> <span>Weighstation</span></a></li> 
                            <li>
                            <li <?php if($page == 'Weighstation')echo "class='active'";?>>
                            ...
                            <li <?php if($page == 'Toll Plaza Staff')echo "class='active'";?>>
                            <a style="color:#fff;" href="<?php echo base_url()?>admin/tpstaff"><i style="color:#fff;" class="fa fa-building"></i> <span>Toll Plaza Staff</span></a></li>
                            <li <?php if($page == 'Toll Plaza Supervisor')echo "class='active'";?>>
                            <a style="color:#fff;" href="<?php echo base_url()?>admin/toolplaza_supervisor"><i style="color:#fff;" class="fa fa-group"></i> <span>Plaza Supervisor</span></a></li> 
                            <li>
                            ...
                            <a style="color:#fff;" href="<?php echo base_url()?>admin/tarrif"> <i style="color:#fff;" class="fa fa-inr" ></i> <span>Tarrif</span></a></li>    
                ...
                <div class="row align-items-center" >
                    <div class="col-sm-8">
                        <div class="breadcrumbs-area clearfix"style='margin-top:12px;'>
                            <h4 class="page-title pull-left"> ETTM Dashboard</h4>
