    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box ptb--100">
                <?php echo form_open(base_url().'omc/do_login',array('id' => 'omc_login'));?>
                    <div class="login-form-head">
                        <h4>OMC Sign In</h4>
                        <p>Welcome To ETTM. &nbsp;Please Login to continue.....</p>
                    </div>
                    <div class="login-form-body">
                        ...
                        <div class="submit-btn-area">
                            <span id="form_submit" class="btn btn-primary btn-lg" onclick="form_submit('omc_login');">Submit <i class="ti-arrow-right"></i></span>
