              ...
              <div class="row">
                <div class="col-sm-12 pl-1 pr-1">
                  ...
                  <tr role="row" class="odd " id="mainrow<?php echo $counter ?>" >
                      <td class="sorting_1">
                      <i class="far fa-caret-square-down" data-toggle="collapse" data-parent="tbody<?php echo $counter ?>"  data-target="#collapseme" style="cursor:pointer;" onclick="expandCollapse(this)">
...
<script>$('body').on('change', '#site', function (){
  ...
  function expandCollapse(assetName){
