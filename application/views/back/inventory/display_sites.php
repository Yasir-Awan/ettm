                    ...
                    <div class='row mb-1 mt-1' >
                      <div class='col-md-4'>
                       ...
                       <div class="col-md-4">
                        ...
                        <div class='col-md-4'>
                          <button type="button" class="btn btn-primary btn-xs pull-right" style="line-height: 0.5; " data-toggle="modal" data-target="#site-modal" onclick="ajax_html('<?php echo base_url()?>inventory/add_site/','adding_sites');">
                              Add Sites </button>
                         </div> <!-- col-md-4 END -->
                     </div><!-- row END -->
