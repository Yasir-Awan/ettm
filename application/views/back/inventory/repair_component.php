<?php echo form_open(base_url()."inventory/action_on_asset/component_repair_do/",array('id' => 'componentrepair'));?>
...
<span class="btn btn-primary pull-right" onclick="form_submit('componentrepair');">Start Repairing</span>
          <?php echo form_close();?>
