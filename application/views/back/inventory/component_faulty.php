<?php echo form_open(base_url()."inventory/action_on_asset/component_faulty_do/",array('id' => 'comp_faulty'));?>
         ...
         <div class="form-group">
                ...
                <div class='col-md-4' style="margin-left:-22px;">
                    <!-- <?php foreach($data1 as $row) {?> -->
                      <input type="text" class="form-control required" name="comp_name" id="comp_name" placeholder="Select  Name" value="<?php echo 'inside '.$equipment_name;?>" readonly >
                      <input type="hidden" class="form-control required" name="comp_id" id="comp_id"  value="<?php echo $equipment_id;?>" >
                    <!-- <?php } ?> -->
                </div>
...
<span class="btn btn-primary pull-right" onclick="form_submit('comp_faulty');">Faulty</span>
          <?php echo form_close();?>
