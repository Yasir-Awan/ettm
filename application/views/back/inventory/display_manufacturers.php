                    ...
                    <div class='row mb-1 mt-1' >
                      <div class='col-md-4'>
                       ...
                       <div class="col-md-4">
                        ...
                        <div class='col-md-4'>
                          <button type="button" class="btn btn-primary btn-xs pull-right" style="line-height: 0.5; " data-toggle="modal" data-target="#manufacturer-modal" onclick="ajax_html('<?php echo base_url()?>inventory/add_manufacturer/','adding_manufacturers');">
                              Add Manufacturers </button>
                         </div> <!-- col-md-4 END -->
                     </div><!-- row END -->
