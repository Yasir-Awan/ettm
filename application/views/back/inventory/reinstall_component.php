<?php echo form_open(base_url()."inventory/action_on_asset/component_reinstall_do/",array('id' => 'reinstall_component'));?>
...
<span class="btn btn-primary pull-right" onclick="form_submit('reinstall_component');">Reinstall</span>
          <?php echo form_close();?>
