var height = $( window ).height();
	...
	function delete_con(url){
		...
		$(document).on('click', '.paginate_button', function(e){
					...
					if(typeof bootstrapToggle === 'undefined'){}
		});
...
function getCrashList(){
	console.log('from sidebar page');
	$.ajax({   
		url: "http://api.roadcrashpk.com/admin/crash/list-all-crashes?page=1",
		type: 'GET',
		// headers : {'Authorization':'Barear db8a789aaee31f2942c5e61d1ae7b48cef152026'},
		beforeSend: function (xhr) {
			xhr.setRequestHeader("Authorization", "Bearer db8a789aaee31f2942c5e61d1ae7b48cef152026");
		},
		success: function(data) {
			console.log(data);
