...
(12, '6 AX TENDEM-TRIDEM', 6, 690, '2019-05-31'),
...
--
-- Indexes for table `weigh_category`
--
ALTER TABLE `weigh_category`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `weigh_category`
--
ALTER TABLE `weigh_category`
